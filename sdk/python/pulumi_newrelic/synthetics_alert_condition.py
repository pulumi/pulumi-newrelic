...
class SyntheticsAlertCondition(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, enabled=None, monitor_id=None, name=None, policy_id=None, runbook_url=None, __name__=None, __opts__=None):
        """
        Create a SyntheticsAlertCondition resource with the given unique name, props, and options.
        ...
        super(SyntheticsAlertCondition, __self__).__init__(
            'newrelic:index/syntheticsAlertCondition:SyntheticsAlertCondition',
            resource_name,
            __props__,
            opts)
