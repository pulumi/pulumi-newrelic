...
class PipelineCloudRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        > **NOTE:** **Starting v3.68.0 of the New Relic Terraform Provider**, <b style="color:green;">Pipeline Cloud Rules can be managed using the [`PipelineCloudRule`](https://www.terraform.io/providers/newrelic/newrelic/latest/docs/resources/pipeline_cloud_rule) resource.</b> This resource is the designated replacement for the <span style="color:red;">now end-of-life [`NrqlDropRule`](https://www.terraform.io/providers/newrelic/newrelic/latest/docs/resources/nrql_drop_rule) resource</span>, which reached its end-of-life on <b style="color:red;">August 31, 2026</b> and will be removed from the provider in an upcoming release. <br><br>If you are currently using the [`NrqlDropRule`](https://www.terraform.io/providers/newrelic/newrelic/latest/docs/resources/nrql_drop_rule) resource, please migrate to [`PipelineCloudRule`](https://www.terraform.io/providers/newrelic/newrelic/latest/docs/resources/pipeline_cloud_rule) at the earliest. Refer to the [Drop Rules EOL Migration Guide](https://www.terraform.io/providers/newrelic/newrelic/latest/docs/guides/drop_rules_eol_guide) for step-by-step instructions.<br><br>
    ...
    def get(resource_name: str,
            ...
            description: pulumi.Input[Optional[_builtins.str]] = None,
            name: pulumi.Input[Optional[_builtins.str]] = None,
            nrql: pulumi.Input[Optional[_builtins.str]] = None) -> 'PipelineCloudRule':
        """
