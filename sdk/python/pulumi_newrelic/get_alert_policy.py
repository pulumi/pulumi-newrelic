...
def get_alert_policy_output(account_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                            incident_preference: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
