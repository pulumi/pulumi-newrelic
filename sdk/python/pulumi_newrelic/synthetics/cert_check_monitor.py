...
class CertCheckMonitorArgs:
    def __init__(__self__, *,
                 ...
                 tags: pulumi.Input[Optional[Sequence[pulumi.Input['CertCheckMonitorTagArgs']]]] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def tags(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['CertCheckMonitorTagArgs']]]]:
        """
    ...
    @tags.setter
    def tags(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['CertCheckMonitorTagArgs']]]]):
...
class _CertCheckMonitorState:
    def __init__(__self__, *,
                 account_id: pulumi.Input[Optional[_builtins.str]] = None,
                 certificate_expiration: pulumi.Input[Optional[_builtins.int]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="certificateExpiration")
    def certificate_expiration(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        The desired number of remaining days until the certificate expires to trigger a monitor failure.
        """
        return pulumi.get(self, "certificate_expiration")
    ...
    @certificate_expiration.setter
    def certificate_expiration(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "certificate_expiration", value)
