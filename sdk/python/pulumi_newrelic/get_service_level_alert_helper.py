...
def get_service_level_alert_helper(alert_type: Optional[_builtins.str] = None,
    ...
    foo_custom = newrelic.get_service_level_alert_helper(alert_type="custom",
        ...
        slo_target=foo_target,
        slo_period=int(foo_period),
        custom_tolerated_budget_consumption=float(4),
...
def get_service_level_alert_helper_output(alert_type: pulumi.Input[Optional[_builtins.str]] = None,
                                          custom_evaluation_period: pulumi.Input[Optional[Optional[_builtins.int]]] = None,
                                          custom_tolerated_budget_consumption: pulumi.Input[Optional[Optional[_builtins.float]]] = None,
                                          is_bad_events: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
                                          sli_guid: pulumi.Input[Optional[_builtins.str]] = None,
                                          slo_period: pulumi.Input[Optional[_builtins.int]] = None,
                                          slo_target: pulumi.Input[Optional[_builtins.float]] = None,
