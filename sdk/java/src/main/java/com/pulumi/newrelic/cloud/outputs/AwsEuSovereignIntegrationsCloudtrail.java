...
@CustomType
public final class AwsEuSovereignIntegrationsCloudtrail {
    /**
    ...
    private AwsEuSovereignIntegrationsCloudtrail() {}
    /**
     * @return Specify each AWS region that includes the resources that you want to monitor
     * 
     */
    ...
    public static Builder builder(AwsEuSovereignIntegrationsCloudtrail defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer metricsPollingInterval;
        public Builder() {}
        public Builder(AwsEuSovereignIntegrationsCloudtrail defaults) {
        ...
        public AwsEuSovereignIntegrationsCloudtrail build() {
            final var _resultValue = new AwsEuSovereignIntegrationsCloudtrail();
