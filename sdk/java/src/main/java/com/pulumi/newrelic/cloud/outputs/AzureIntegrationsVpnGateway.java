...
@CustomType
public final class AzureIntegrationsVpnGateway {
    /**
    ...
    private AzureIntegrationsVpnGateway() {}
    /**
     * @return The data polling interval in seconds.
     * 
     */
    ...
    public static Builder builder(AzureIntegrationsVpnGateway defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> resourceGroups;
        public Builder() {}
        public Builder(AzureIntegrationsVpnGateway defaults) {
