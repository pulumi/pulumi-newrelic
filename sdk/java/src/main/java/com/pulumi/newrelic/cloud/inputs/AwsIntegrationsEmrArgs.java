...
public final class AwsIntegrationsEmrArgs extends com.pulumi.resources.ResourceArgs {

    public static final AwsIntegrationsEmrArgs Empty = new AwsIntegrationsEmrArgs();
    ...
    private AwsIntegrationsEmrArgs() {}

    private AwsIntegrationsEmrArgs(AwsIntegrationsEmrArgs $) {
    ...
    public static Builder builder(AwsIntegrationsEmrArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AwsIntegrationsEmrArgs();
        }

        public Builder(AwsIntegrationsEmrArgs defaults) {
            $ = new AwsIntegrationsEmrArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AwsIntegrationsEmrArgs build() {
            return $;
        }
    }
