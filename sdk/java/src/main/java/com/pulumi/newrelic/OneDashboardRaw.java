...
public class OneDashboardRaw extends com.pulumi.resources.CustomResource {
     ...
     */
    public OneDashboardRaw(java.lang.String name) {
     ...
     */
    public OneDashboardRaw(java.lang.String name, OneDashboardRawArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public OneDashboardRaw(java.lang.String name, OneDashboardRawArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("newrelic:index/oneDashboardRaw:OneDashboardRaw", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private OneDashboardRaw(java.lang.String name, Output<java.lang.String> id, @Nullable OneDashboardRawState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("newrelic:index/oneDashboardRaw:OneDashboardRaw", name, state, makeResourceOptions(options, id), false);
    }

    private static OneDashboardRawArgs makeArgs(OneDashboardRawArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? OneDashboardRawArgs.Empty : args;
    }
     ...
     */
    public static OneDashboardRaw get(java.lang.String name, Output<java.lang.String> id, @Nullable OneDashboardRawState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
