...
@CustomType
public final class AzureIntegrationsVirtualMachine {
    /**
    ...
    private AzureIntegrationsVirtualMachine() {}
    /**
     * @return The data polling interval in seconds.
     * 
     */
    ...
    public static Builder builder(AzureIntegrationsVirtualMachine defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> resourceGroups;
        public Builder() {}
        public Builder(AzureIntegrationsVirtualMachine defaults) {
