...
import com.pulumi.newrelic.inputs.OneDashboardPageWidgetPyChartStylesArgs;
import com.pulumi.newrelic.inputs.OneDashboardPageWidgetPyColorArgs;
import com.pulumi.newrelic.inputs.OneDashboardPageWidgetPyDataFormatArgs;
import com.pulumi.newrelic.inputs.OneDashboardPageWidgetPyInitialSortingArgs;
...
import com.pulumi.newrelic.inputs.OneDashboardPageWidgetPyUnitArgs;
...
public final class OneDashboardPageWidgetPyArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<OneDashboardPageWidgetPyChartStylesArgs> chartStyles;
     ...
     * 
     */
    public Optional<Output<OneDashboardPageWidgetPyChartStylesArgs>> chartStyles() {
     ...
     */
    @Import(name="colors")
    private @Nullable Output<List<OneDashboardPageWidgetPyColorArgs>> colors;
     ...
     * 
     */
    public Optional<Output<List<OneDashboardPageWidgetPyColorArgs>>> colors() {
    ...
    private @Nullable Output<List<OneDashboardPageWidgetPyDataFormatArgs>> dataFormats;

    /**
     * @return (Optional) A nested block that describes data format. See Nested dataFormat blocks below for details.
     * 
     */
    public Optional<Output<List<OneDashboardPageWidgetPyDataFormatArgs>>> dataFormats() {
    ...
    private @Nullable Output<OneDashboardPageWidgetPyInitialSortingArgs> initialSorting;
     ...
     * 
     */
    public Optional<Output<OneDashboardPageWidgetPyInitialSortingArgs>> initialSorting() {
    ...
    private @Nullable Output<List<OneDashboardPageWidgetPyNullValueArgs>> nullValues;

    /**
     * @return (Optional) A nested block that describes a Null Values. See Nested Null Values blocks below for details.
     * 
     */
    public Optional<Output<List<OneDashboardPageWidgetPyNullValueArgs>>> nullValues() {
     ...
     */
    @Import(name="units")
    private @Nullable Output<List<OneDashboardPageWidgetPyUnitArgs>> units;

    /**
     * @return (Optional) A nested block that describes units on your Y axis. See Nested Units blocks below for details.
     * 
     */
    public Optional<Output<List<OneDashboardPageWidgetPyUnitArgs>>> units() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder chartStyles(@Nullable Output<OneDashboardPageWidgetPyChartStylesArgs> chartStyles) {
         ...
         * 
         */
        public Builder chartStyles(OneDashboardPageWidgetPyChartStylesArgs chartStyles) {
         ...
         * 
         */
        public Builder colors(@Nullable Output<List<OneDashboardPageWidgetPyColorArgs>> colors) {
            $.colors = colors;
            return this;
        }
         ...
         * 
         */
        public Builder colors(List<OneDashboardPageWidgetPyColorArgs> colors) {
         ...
         * 
         */
        public Builder colors(OneDashboardPageWidgetPyColorArgs... colors) {
         ...
         * 
         */
        public Builder dataFormats(@Nullable Output<List<OneDashboardPageWidgetPyDataFormatArgs>> dataFormats) {
         ...
         * 
         */
        public Builder dataFormats(List<OneDashboardPageWidgetPyDataFormatArgs> dataFormats) {
         ...
         * 
         */
        public Builder dataFormats(OneDashboardPageWidgetPyDataFormatArgs... dataFormats) {
         ...
         * 
         */
        public Builder initialSorting(@Nullable Output<OneDashboardPageWidgetPyInitialSortingArgs> initialSorting) {
         ...
         * 
         */
        public Builder initialSorting(OneDashboardPageWidgetPyInitialSortingArgs initialSorting) {
         ...
         * 
         */
        public Builder nullValues(@Nullable Output<List<OneDashboardPageWidgetPyNullValueArgs>> nullValues) {
         ...
         * 
         */
        public Builder nullValues(List<OneDashboardPageWidgetPyNullValueArgs> nullValues) {
         ...
         * 
         */
        public Builder nullValues(OneDashboardPageWidgetPyNullValueArgs... nullValues) {
         ...
         * 
         */
        public Builder units(@Nullable Output<List<OneDashboardPageWidgetPyUnitArgs>> units) {
            $.units = units;
            return this;
        }
         ...
         * 
         */
        public Builder units(List<OneDashboardPageWidgetPyUnitArgs> units) {
         ...
         * 
         */
        public Builder units(OneDashboardPageWidgetPyUnitArgs... units) {
