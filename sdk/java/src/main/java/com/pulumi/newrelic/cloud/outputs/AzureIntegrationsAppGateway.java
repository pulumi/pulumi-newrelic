...
@CustomType
public final class AzureIntegrationsAppGateway {
    /**
    ...
    private AzureIntegrationsAppGateway() {}
    /**
     * @return The data polling interval in seconds
     * 
     */
    ...
    public static Builder builder(AzureIntegrationsAppGateway defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> resourceGroups;
        public Builder() {}
        public Builder(AzureIntegrationsAppGateway defaults) {
        ...
        public AzureIntegrationsAppGateway build() {
            final var _resultValue = new AzureIntegrationsAppGateway();
