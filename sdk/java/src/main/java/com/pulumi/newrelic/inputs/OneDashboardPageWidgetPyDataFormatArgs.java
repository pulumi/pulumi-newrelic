...
public final class OneDashboardPageWidgetPyDataFormatArgs extends com.pulumi.resources.ResourceArgs {

    public static final OneDashboardPageWidgetPyDataFormatArgs Empty = new OneDashboardPageWidgetPyDataFormatArgs();
    ...
    private OneDashboardPageWidgetPyDataFormatArgs() {}

    private OneDashboardPageWidgetPyDataFormatArgs(OneDashboardPageWidgetPyDataFormatArgs $) {
        this.format = $.format;
        this.name = $.name;
    ...
    public static Builder builder(OneDashboardPageWidgetPyDataFormatArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new OneDashboardPageWidgetPyDataFormatArgs();
        }

        public Builder(OneDashboardPageWidgetPyDataFormatArgs defaults) {
            $ = new OneDashboardPageWidgetPyDataFormatArgs(Objects.requireNonNull(defaults));
        }
        ...
        public OneDashboardPageWidgetPyDataFormatArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("OneDashboardPageWidgetPyDataFormatArgs", "name");
            }
            if ($.type == null) {
                throw new MissingRequiredPropertyException("OneDashboardPageWidgetPyDataFormatArgs", "type");
            }
            return $;
        }
    }
