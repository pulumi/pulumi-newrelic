...
import com.pulumi.newrelic.inputs.OneDashboardPageWidgetStackedBarColorSeriesOverrideArgs;
...
public final class OneDashboardPageWidgetStackedBarColorArgs extends com.pulumi.resources.ResourceArgs {

    public static final OneDashboardPageWidgetStackedBarColorArgs Empty = new OneDashboardPageWidgetStackedBarColorArgs();
    ...
    private OneDashboardPageWidgetStackedBarColorArgs() {}

    private OneDashboardPageWidgetStackedBarColorArgs(OneDashboardPageWidgetStackedBarColorArgs $) {
        this.color = $.color;
    ...
    public static Builder builder(OneDashboardPageWidgetStackedBarColorArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new OneDashboardPageWidgetStackedBarColorArgs();
        }

        public Builder(OneDashboardPageWidgetStackedBarColorArgs defaults) {
            $ = new OneDashboardPageWidgetStackedBarColorArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder seriesOverrides(@Nullable Output<List<OneDashboardPageWidgetStackedBarColorSeriesOverrideArgs>> seriesOverrides) {
         ...
         * 
         */
        public Builder seriesOverrides(List<OneDashboardPageWidgetStackedBarColorSeriesOverrideArgs> seriesOverrides) {
         ...
         * 
         */
        public Builder seriesOverrides(OneDashboardPageWidgetStackedBarColorSeriesOverrideArgs... seriesOverrides) {
            return seriesOverrides(List.of(seriesOverrides));
        }

        public OneDashboardPageWidgetStackedBarColorArgs build() {
            return $;
        }
    }
