...
@CustomType
public final class AzureIntegrationsPowerBiDedicated {
    /**
    ...
    private AzureIntegrationsPowerBiDedicated() {}
    /**
     * @return The data polling interval in seconds
     * 
     */
    ...
    public static Builder builder(AzureIntegrationsPowerBiDedicated defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> resourceGroups;
        public Builder() {}
        public Builder(AzureIntegrationsPowerBiDedicated defaults) {
