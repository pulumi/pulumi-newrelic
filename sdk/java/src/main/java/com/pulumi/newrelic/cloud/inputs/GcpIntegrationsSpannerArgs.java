...
public final class GcpIntegrationsSpannerArgs extends com.pulumi.resources.ResourceArgs {

    public static final GcpIntegrationsSpannerArgs Empty = new GcpIntegrationsSpannerArgs();
    ...
    private GcpIntegrationsSpannerArgs() {}

    private GcpIntegrationsSpannerArgs(GcpIntegrationsSpannerArgs $) {
    ...
    public static Builder builder(GcpIntegrationsSpannerArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GcpIntegrationsSpannerArgs();
        }

        public Builder(GcpIntegrationsSpannerArgs defaults) {
            $ = new GcpIntegrationsSpannerArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GcpIntegrationsSpannerArgs build() {
            return $;
        }
    }
