...
public final class AwsIntegrationsAwsRoute53resolverArgs extends com.pulumi.resources.ResourceArgs {

    public static final AwsIntegrationsAwsRoute53resolverArgs Empty = new AwsIntegrationsAwsRoute53resolverArgs();
    ...
    private AwsIntegrationsAwsRoute53resolverArgs() {}

    private AwsIntegrationsAwsRoute53resolverArgs(AwsIntegrationsAwsRoute53resolverArgs $) {
    ...
    public static Builder builder(AwsIntegrationsAwsRoute53resolverArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AwsIntegrationsAwsRoute53resolverArgs();
        }

        public Builder(AwsIntegrationsAwsRoute53resolverArgs defaults) {
            $ = new AwsIntegrationsAwsRoute53resolverArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AwsIntegrationsAwsRoute53resolverArgs build() {
            return $;
        }
    }
