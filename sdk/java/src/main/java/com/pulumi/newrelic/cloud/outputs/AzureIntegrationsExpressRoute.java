...
@CustomType
public final class AzureIntegrationsExpressRoute {
    /**
    ...
    private AzureIntegrationsExpressRoute() {}
    /**
     * @return The data polling interval in seconds
     * 
     */
    ...
    public static Builder builder(AzureIntegrationsExpressRoute defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> resourceGroups;
        public Builder() {}
        public Builder(AzureIntegrationsExpressRoute defaults) {
