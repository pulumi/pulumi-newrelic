...
@CustomType
public final class OneDashboardPageWidgetFunnelColorSeriesOverride {
    /**
    ...
    public static Builder builder(OneDashboardPageWidgetFunnelColorSeriesOverride defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String seriesName;
        public Builder() {}
        public Builder(OneDashboardPageWidgetFunnelColorSeriesOverride defaults) {
