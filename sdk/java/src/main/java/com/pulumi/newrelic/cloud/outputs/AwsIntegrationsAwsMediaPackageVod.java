...
@CustomType
public final class AwsIntegrationsAwsMediaPackageVod {
    /**
    ...
    private AwsIntegrationsAwsMediaPackageVod() {}
    /**
     * @return Specify each AWS region that includes the resources that you want to monitor.
     * 
     */
    ...
    public static Builder builder(AwsIntegrationsAwsMediaPackageVod defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer metricsPollingInterval;
        public Builder() {}
        public Builder(AwsIntegrationsAwsMediaPackageVod defaults) {
