...
public class AzureLinkAccount extends com.pulumi.resources.CustomResource {
     ...
     */
    public AzureLinkAccount(java.lang.String name) {
     ...
     */
    public AzureLinkAccount(java.lang.String name, AzureLinkAccountArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public AzureLinkAccount(java.lang.String name, AzureLinkAccountArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("newrelic:cloud/azureLinkAccount:AzureLinkAccount", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private AzureLinkAccount(java.lang.String name, Output<java.lang.String> id, @Nullable AzureLinkAccountState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("newrelic:cloud/azureLinkAccount:AzureLinkAccount", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static AzureLinkAccount get(java.lang.String name, Output<java.lang.String> id, @Nullable AzureLinkAccountState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
