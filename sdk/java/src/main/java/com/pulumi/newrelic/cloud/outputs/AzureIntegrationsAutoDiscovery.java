...
public final class AzureIntegrationsAutoDiscovery {
    ...
    public static Builder builder(AzureIntegrationsAutoDiscovery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> resourceGroups;
        public Builder() {}
        public Builder(AzureIntegrationsAutoDiscovery defaults) {
        ...
        public AzureIntegrationsAutoDiscovery build() {
            final var _resultValue = new AzureIntegrationsAutoDiscovery();
