...
@CustomType
public final class AzureIntegrationsFunctions {
    /**
    ...
    private AzureIntegrationsFunctions() {}
    /**
     * @return The data polling interval in seconds.
     * 
     */
    ...
    public static Builder builder(AzureIntegrationsFunctions defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> resourceGroups;
        public Builder() {}
        public Builder(AzureIntegrationsFunctions defaults) {
