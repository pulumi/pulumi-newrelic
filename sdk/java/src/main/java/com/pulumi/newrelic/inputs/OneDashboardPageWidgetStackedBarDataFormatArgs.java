...
public final class OneDashboardPageWidgetStackedBarDataFormatArgs extends com.pulumi.resources.ResourceArgs {

    public static final OneDashboardPageWidgetStackedBarDataFormatArgs Empty = new OneDashboardPageWidgetStackedBarDataFormatArgs();
    ...
    private OneDashboardPageWidgetStackedBarDataFormatArgs() {}

    private OneDashboardPageWidgetStackedBarDataFormatArgs(OneDashboardPageWidgetStackedBarDataFormatArgs $) {
        this.format = $.format;
        this.name = $.name;
    ...
    public static Builder builder(OneDashboardPageWidgetStackedBarDataFormatArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new OneDashboardPageWidgetStackedBarDataFormatArgs();
        }

        public Builder(OneDashboardPageWidgetStackedBarDataFormatArgs defaults) {
            $ = new OneDashboardPageWidgetStackedBarDataFormatArgs(Objects.requireNonNull(defaults));
        }
        ...
        public OneDashboardPageWidgetStackedBarDataFormatArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("OneDashboardPageWidgetStackedBarDataFormatArgs", "name");
            }
            if ($.type == null) {
                throw new MissingRequiredPropertyException("OneDashboardPageWidgetStackedBarDataFormatArgs", "type");
            }
            return $;
        }
    }
