...
@CustomType
public final class AwsIntegrationsAlb {
    /**
     ...
     * 
     */
    public List<String> loadBalancerPrefixes() {
    ...
    public static Builder builder(AwsIntegrationsAlb defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String tagValue;
        public Builder() {}
        public Builder(AwsIntegrationsAlb defaults) {
    	      ...
    	      this.loadBalancerPrefixes = defaults.loadBalancerPrefixes;
        ...
        @CustomType.Setter
        public Builder loadBalancerPrefixes(@Nullable List<String> loadBalancerPrefixes) {
        ...
        public AwsIntegrationsAlb build() {
            final var _resultValue = new AwsIntegrationsAlb();
