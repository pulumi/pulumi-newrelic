...
@CustomType
public final class AzureIntegrationsRedisCache {
    /**
    ...
    private AzureIntegrationsRedisCache() {}
    /**
     * @return The data polling interval in seconds
     * 
     */
    ...
    public static Builder builder(AzureIntegrationsRedisCache defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> resourceGroups;
        public Builder() {}
        public Builder(AzureIntegrationsRedisCache defaults) {
        ...
        public AzureIntegrationsRedisCache build() {
            final var _resultValue = new AzureIntegrationsRedisCache();
