...
@CustomType
public final class GcpIntegrationsFireBaseDatabase {
    /**
    ...
    private GcpIntegrationsFireBaseDatabase() {}
    /**
     * @return The data polling interval in seconds.
     * 
     * Other integration supports an additional argument:
    ...
    public static Builder builder(GcpIntegrationsFireBaseDatabase defaults) {
    ...
    public static final class Builder {
        private @Nullable Integer metricsPollingInterval;
        public Builder() {}
        public Builder(GcpIntegrationsFireBaseDatabase defaults) {
