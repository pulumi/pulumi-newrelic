...
@CustomType
public final class AwsIntegrationsAwsCognito {
    /**
    ...
    public static Builder builder(AwsIntegrationsAwsCognito defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer metricsPollingInterval;
        public Builder() {}
        public Builder(AwsIntegrationsAwsCognito defaults) {
        ...
        public AwsIntegrationsAwsCognito build() {
            final var _resultValue = new AwsIntegrationsAwsCognito();
