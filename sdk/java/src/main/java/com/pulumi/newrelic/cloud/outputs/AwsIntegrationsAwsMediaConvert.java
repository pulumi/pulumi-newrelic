...
@CustomType
public final class AwsIntegrationsAwsMediaConvert {
    /**
    ...
    private AwsIntegrationsAwsMediaConvert() {}
    /**
     * @return Specify each AWS region that includes the resources that you want to monitor.
     * 
     */
    ...
    public static Builder builder(AwsIntegrationsAwsMediaConvert defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer metricsPollingInterval;
        public Builder() {}
        public Builder(AwsIntegrationsAwsMediaConvert defaults) {
