...
@CustomType
public final class AzureIntegrationsMysqlFlexible {
    /**
    ...
    private AzureIntegrationsMysqlFlexible() {}
    /**
     * @return The data polling interval in seconds.
     * 
     */
    ...
    public static Builder builder(AzureIntegrationsMysqlFlexible defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> resourceGroups;
        public Builder() {}
        public Builder(AzureIntegrationsMysqlFlexible defaults) {
