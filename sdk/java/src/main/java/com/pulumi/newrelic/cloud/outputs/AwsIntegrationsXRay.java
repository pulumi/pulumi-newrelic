...
public final class AwsIntegrationsXRay {
    ...
    public static Builder builder(AwsIntegrationsXRay defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer metricsPollingInterval;
        public Builder() {}
        public Builder(AwsIntegrationsXRay defaults) {
        ...
        public AwsIntegrationsXRay build() {
            final var _resultValue = new AwsIntegrationsXRay();
