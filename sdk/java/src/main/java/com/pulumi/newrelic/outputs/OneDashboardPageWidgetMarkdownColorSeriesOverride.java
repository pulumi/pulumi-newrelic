...
@CustomType
public final class OneDashboardPageWidgetMarkdownColorSeriesOverride {
    /**
    ...
    public static Builder builder(OneDashboardPageWidgetMarkdownColorSeriesOverride defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String seriesName;
        public Builder() {}
        public Builder(OneDashboardPageWidgetMarkdownColorSeriesOverride defaults) {
        ...
        public OneDashboardPageWidgetMarkdownColorSeriesOverride build() {
            final var _resultValue = new OneDashboardPageWidgetMarkdownColorSeriesOverride();
