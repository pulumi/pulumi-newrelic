...
public final class OneDashboardPageWidgetHeatmapDataFormatArgs extends com.pulumi.resources.ResourceArgs {

    public static final OneDashboardPageWidgetHeatmapDataFormatArgs Empty = new OneDashboardPageWidgetHeatmapDataFormatArgs();
    ...
    private OneDashboardPageWidgetHeatmapDataFormatArgs() {}

    private OneDashboardPageWidgetHeatmapDataFormatArgs(OneDashboardPageWidgetHeatmapDataFormatArgs $) {
        this.format = $.format;
        this.name = $.name;
    ...
    public static Builder builder(OneDashboardPageWidgetHeatmapDataFormatArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new OneDashboardPageWidgetHeatmapDataFormatArgs();
        }

        public Builder(OneDashboardPageWidgetHeatmapDataFormatArgs defaults) {
            $ = new OneDashboardPageWidgetHeatmapDataFormatArgs(Objects.requireNonNull(defaults));
        }
        ...
        public OneDashboardPageWidgetHeatmapDataFormatArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("OneDashboardPageWidgetHeatmapDataFormatArgs", "name");
            }
            if ($.type == null) {
                throw new MissingRequiredPropertyException("OneDashboardPageWidgetHeatmapDataFormatArgs", "type");
            }
            return $;
        }
    }
