...
@CustomType
public final class AzureIntegrationsCosmosDb {
    /**
    ...
    public static Builder builder(AzureIntegrationsCosmosDb defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> resourceGroups;
        public Builder() {}
        public Builder(AzureIntegrationsCosmosDb defaults) {
