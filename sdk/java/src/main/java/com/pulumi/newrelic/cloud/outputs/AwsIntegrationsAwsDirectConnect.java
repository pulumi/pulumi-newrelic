...
@CustomType
public final class AwsIntegrationsAwsDirectConnect {
    /**
    ...
    private AwsIntegrationsAwsDirectConnect() {}
    /**
     * @return Specify each AWS region that includes the resources that you want to monitor.
     * 
     */
    ...
    public static Builder builder(AwsIntegrationsAwsDirectConnect defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer metricsPollingInterval;
        public Builder() {}
        public Builder(AwsIntegrationsAwsDirectConnect defaults) {
        ...
        public AwsIntegrationsAwsDirectConnect build() {
            final var _resultValue = new AwsIntegrationsAwsDirectConnect();
