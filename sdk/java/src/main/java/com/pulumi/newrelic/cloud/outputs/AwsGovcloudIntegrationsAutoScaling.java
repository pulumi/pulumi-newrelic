...
@CustomType
public final class AwsGovcloudIntegrationsAutoScaling {
    /**
    ...
    private AwsGovcloudIntegrationsAutoScaling() {}
    /**
     * @return Specify each AWS region that includes the resources that you want to monitor.
     * 
     */
    ...
    public static Builder builder(AwsGovcloudIntegrationsAutoScaling defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer metricsPollingInterval;
        public Builder() {}
        public Builder(AwsGovcloudIntegrationsAutoScaling defaults) {
