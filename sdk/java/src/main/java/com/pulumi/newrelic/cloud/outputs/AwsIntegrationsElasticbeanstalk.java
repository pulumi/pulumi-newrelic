...
@CustomType
public final class AwsIntegrationsElasticbeanstalk {
    /**
    ...
    private AwsIntegrationsElasticbeanstalk() {}
    /**
     * @return Specify each AWS region that includes the resources that you want to monitor.
     * &lt;/details&gt;
     * 
    ...
    public static Builder builder(AwsIntegrationsElasticbeanstalk defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String tagValue;
        public Builder() {}
        public Builder(AwsIntegrationsElasticbeanstalk defaults) {
