...
@CustomType
public final class AwsIntegrationsAwsStates {
    /**
    ...
    private AwsIntegrationsAwsStates() {}
    /**
     * @return Specify each AWS region that includes the resources that you want to monitor.
     * &lt;/details&gt;
     * 
    ...
    public static Builder builder(AwsIntegrationsAwsStates defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer metricsPollingInterval;
        public Builder() {}
        public Builder(AwsIntegrationsAwsStates defaults) {
