...
@CustomType
public final class OneDashboardPageWidgetLogTableNrqlQuery {
    /**
    ...
    public static Builder builder(OneDashboardPageWidgetLogTableNrqlQuery defaults) {
    ...
    public static final class Builder {
        ...
        private String query;
        public Builder() {}
        public Builder(OneDashboardPageWidgetLogTableNrqlQuery defaults) {
        ...
        public Builder query(String query) {
            if (query == null) {
              throw new MissingRequiredPropertyException("OneDashboardPageWidgetLogTableNrqlQuery", "query");
            }
            this.query = query;
            return this;
        }
