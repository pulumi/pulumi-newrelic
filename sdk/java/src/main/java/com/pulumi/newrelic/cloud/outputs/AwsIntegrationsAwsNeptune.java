...
@CustomType
public final class AwsIntegrationsAwsNeptune {
    /**
    ...
    private AwsIntegrationsAwsNeptune() {}
    /**
     * @return Specify each AWS region that includes the resources that you want to monitor.
     * &lt;/details&gt;
     * 
    ...
    public static Builder builder(AwsIntegrationsAwsNeptune defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer metricsPollingInterval;
        public Builder() {}
        public Builder(AwsIntegrationsAwsNeptune defaults) {
        ...
        public AwsIntegrationsAwsNeptune build() {
            final var _resultValue = new AwsIntegrationsAwsNeptune();
