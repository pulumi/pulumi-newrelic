...
public final class AzureIntegrationsSqlArgs extends com.pulumi.resources.ResourceArgs {

    public static final AzureIntegrationsSqlArgs Empty = new AzureIntegrationsSqlArgs();
    ...
    private AzureIntegrationsSqlArgs() {}

    private AzureIntegrationsSqlArgs(AzureIntegrationsSqlArgs $) {
    ...
    public static Builder builder(AzureIntegrationsSqlArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AzureIntegrationsSqlArgs();
        }

        public Builder(AzureIntegrationsSqlArgs defaults) {
            $ = new AzureIntegrationsSqlArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AzureIntegrationsSqlArgs build() {
            return $;
        }
    }
