...
@CustomType
public final class AzureIntegrationsStorage {
    /**
    ...
    private AzureIntegrationsStorage() {}
    /**
     * @return The data polling interval in seconds
     * 
     */
    ...
    public static Builder builder(AzureIntegrationsStorage defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> resourceGroups;
        public Builder() {}
        public Builder(AzureIntegrationsStorage defaults) {
        ...
        public AzureIntegrationsStorage build() {
            final var _resultValue = new AzureIntegrationsStorage();
