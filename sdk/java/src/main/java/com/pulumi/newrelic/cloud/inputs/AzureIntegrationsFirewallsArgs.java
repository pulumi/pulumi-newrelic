...
public final class AzureIntegrationsFirewallsArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private AzureIntegrationsFirewallsArgs() {}

    private AzureIntegrationsFirewallsArgs(AzureIntegrationsFirewallsArgs $) {
    ...
    public static Builder builder(AzureIntegrationsFirewallsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AzureIntegrationsFirewallsArgs();
        }

        public Builder(AzureIntegrationsFirewallsArgs defaults) {
            $ = new AzureIntegrationsFirewallsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AzureIntegrationsFirewallsArgs build() {
            return $;
        }
    }
