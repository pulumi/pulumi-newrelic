...
public final class ServiceLevelEventsBadEventsSelect {
    ...
    public static Builder builder(ServiceLevelEventsBadEventsSelect defaults) {
    ...
    public static final class Builder {
        ...
        public Builder function(String function) {
            if (function == null) {
              throw new MissingRequiredPropertyException("ServiceLevelEventsBadEventsSelect", "function");
            }
