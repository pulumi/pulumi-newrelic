...
public final class WorkflowIssuesFilterPredicateArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public WorkflowIssuesFilterPredicateArgs build() {
            if ($.attribute == null) {
                throw new MissingRequiredPropertyException("WorkflowIssuesFilterPredicateArgs", "attribute");
            }
            if ($.operator == null) {
                throw new MissingRequiredPropertyException("WorkflowIssuesFilterPredicateArgs", "operator");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("WorkflowIssuesFilterPredicateArgs", "values");
            }
            return $;
        }
    }
