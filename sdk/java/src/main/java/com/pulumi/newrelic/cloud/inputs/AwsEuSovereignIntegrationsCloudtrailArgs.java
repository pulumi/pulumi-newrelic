...
public final class AwsEuSovereignIntegrationsCloudtrailArgs extends com.pulumi.resources.ResourceArgs {

    public static final AwsEuSovereignIntegrationsCloudtrailArgs Empty = new AwsEuSovereignIntegrationsCloudtrailArgs();
    ...
    private AwsEuSovereignIntegrationsCloudtrailArgs() {}

    private AwsEuSovereignIntegrationsCloudtrailArgs(AwsEuSovereignIntegrationsCloudtrailArgs $) {
    ...
    public static Builder builder(AwsEuSovereignIntegrationsCloudtrailArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AwsEuSovereignIntegrationsCloudtrailArgs();
        }

        public Builder(AwsEuSovereignIntegrationsCloudtrailArgs defaults) {
            $ = new AwsEuSovereignIntegrationsCloudtrailArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AwsEuSovereignIntegrationsCloudtrailArgs build() {
            return $;
        }
    }
