...
@CustomType
public final class AwsIntegrationsCloudtrail {
    /**
    ...
    private AwsIntegrationsCloudtrail() {}
    /**
     * @return Specify each AWS region that includes the resources that you want to monitor.
     * 
     */
    ...
    public static Builder builder(AwsIntegrationsCloudtrail defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer metricsPollingInterval;
        public Builder() {}
        public Builder(AwsIntegrationsCloudtrail defaults) {
        ...
        public AwsIntegrationsCloudtrail build() {
            final var _resultValue = new AwsIntegrationsCloudtrail();
