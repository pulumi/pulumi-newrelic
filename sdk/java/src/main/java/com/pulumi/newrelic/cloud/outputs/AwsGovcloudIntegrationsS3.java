...
public final class AwsGovcloudIntegrationsS3 {
    ...
    public static Builder builder(AwsGovcloudIntegrationsS3 defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String tagValue;
        public Builder() {}
        public Builder(AwsGovcloudIntegrationsS3 defaults) {
        ...
        public AwsGovcloudIntegrationsS3 build() {
            final var _resultValue = new AwsGovcloudIntegrationsS3();
