...
@CustomType
public final class AwsIntegrationsAutoScaling {
    /**
    ...
    private AwsIntegrationsAutoScaling() {}
    /**
     * @return Specify each AWS region that includes the resources that you want to monitor.
     * 
     */
    ...
    public static Builder builder(AwsIntegrationsAutoScaling defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer metricsPollingInterval;
        public Builder() {}
        public Builder(AwsIntegrationsAutoScaling defaults) {
