...
@CustomType
public final class AwsIntegrationsAwsWafv2 {
    /**
    ...
    public static Builder builder(AwsIntegrationsAwsWafv2 defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer metricsPollingInterval;
        public Builder() {}
        public Builder(AwsIntegrationsAwsWafv2 defaults) {
        ...
        public AwsIntegrationsAwsWafv2 build() {
            final var _resultValue = new AwsIntegrationsAwsWafv2();
