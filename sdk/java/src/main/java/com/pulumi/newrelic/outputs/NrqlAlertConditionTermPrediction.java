...
@CustomType
public final class NrqlAlertConditionTermPrediction {
    /**
    ...
    private NrqlAlertConditionTermPrediction() {}
    /**
     * @return BETA PREVIEW: the `predictBy` field is in limited release and only enabled for preview on a per-account basis. - The duration, in seconds, that the prediction should look into the future.
     * 
     */
    ...
    public static Builder builder(NrqlAlertConditionTermPrediction defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean preferPredictionViolation;
        public Builder() {}
        public Builder(NrqlAlertConditionTermPrediction defaults) {
        ...
        public NrqlAlertConditionTermPrediction build() {
            final var _resultValue = new NrqlAlertConditionTermPrediction();
