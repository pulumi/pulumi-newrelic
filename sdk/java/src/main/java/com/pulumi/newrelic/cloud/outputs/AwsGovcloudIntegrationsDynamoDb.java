...
@CustomType
public final class AwsGovcloudIntegrationsDynamoDb {
    /**
    ...
    private AwsGovcloudIntegrationsDynamoDb() {}
    /**
     * @return Specify each AWS region that includes the resources that you want to monitor.
     * 
     */
    ...
    public static Builder builder(AwsGovcloudIntegrationsDynamoDb defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String tagValue;
        public Builder() {}
        public Builder(AwsGovcloudIntegrationsDynamoDb defaults) {
