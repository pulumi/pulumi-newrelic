...
@CustomType
public final class AzureIntegrationsAppService {
    /**
    ...
    private AzureIntegrationsAppService() {}
    /**
     * @return The data polling interval in seconds
     * 
     */
    ...
    public static Builder builder(AzureIntegrationsAppService defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> resourceGroups;
        public Builder() {}
        public Builder(AzureIntegrationsAppService defaults) {
        ...
        public AzureIntegrationsAppService build() {
            final var _resultValue = new AzureIntegrationsAppService();
