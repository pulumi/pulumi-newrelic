...
public final class AzureIntegrationsKeyVaultArgs extends com.pulumi.resources.ResourceArgs {

    public static final AzureIntegrationsKeyVaultArgs Empty = new AzureIntegrationsKeyVaultArgs();
    ...
    private AzureIntegrationsKeyVaultArgs() {}

    private AzureIntegrationsKeyVaultArgs(AzureIntegrationsKeyVaultArgs $) {
    ...
    public static Builder builder(AzureIntegrationsKeyVaultArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AzureIntegrationsKeyVaultArgs();
        }

        public Builder(AzureIntegrationsKeyVaultArgs defaults) {
            $ = new AzureIntegrationsKeyVaultArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AzureIntegrationsKeyVaultArgs build() {
            return $;
        }
    }
