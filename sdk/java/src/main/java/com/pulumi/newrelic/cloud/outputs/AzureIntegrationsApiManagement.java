...
@CustomType
public final class AzureIntegrationsApiManagement {
    /**
    ...
    private AzureIntegrationsApiManagement() {}
    /**
     * @return The data polling interval in seconds.
     * 
     */
    ...
    public static Builder builder(AzureIntegrationsApiManagement defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> resourceGroups;
        public Builder() {}
        public Builder(AzureIntegrationsApiManagement defaults) {
        ...
        public AzureIntegrationsApiManagement build() {
            final var _resultValue = new AzureIntegrationsApiManagement();
