...
@CustomType
public final class AwsGovcloudIntegrationsLambda {
    /**
    ...
    private AwsGovcloudIntegrationsLambda() {}
    /**
     * @return Specify each AWS region that includes the resources that you want to monitor.
     * 
     */
    ...
    public static Builder builder(AwsGovcloudIntegrationsLambda defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String tagValue;
        public Builder() {}
        public Builder(AwsGovcloudIntegrationsLambda defaults) {
        ...
        public AwsGovcloudIntegrationsLambda build() {
            final var _resultValue = new AwsGovcloudIntegrationsLambda();
