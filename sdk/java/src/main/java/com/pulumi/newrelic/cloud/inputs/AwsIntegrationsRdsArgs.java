...
public final class AwsIntegrationsRdsArgs extends com.pulumi.resources.ResourceArgs {

    public static final AwsIntegrationsRdsArgs Empty = new AwsIntegrationsRdsArgs();
    ...
    private AwsIntegrationsRdsArgs() {}

    private AwsIntegrationsRdsArgs(AwsIntegrationsRdsArgs $) {
    ...
    public static Builder builder(AwsIntegrationsRdsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AwsIntegrationsRdsArgs();
        }

        public Builder(AwsIntegrationsRdsArgs defaults) {
            $ = new AwsIntegrationsRdsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AwsIntegrationsRdsArgs build() {
            return $;
        }
    }
