...
public final class AwsIntegrationsAwsGlueArgs extends com.pulumi.resources.ResourceArgs {

    public static final AwsIntegrationsAwsGlueArgs Empty = new AwsIntegrationsAwsGlueArgs();
    ...
    private AwsIntegrationsAwsGlueArgs() {}

    private AwsIntegrationsAwsGlueArgs(AwsIntegrationsAwsGlueArgs $) {
    ...
    public static Builder builder(AwsIntegrationsAwsGlueArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AwsIntegrationsAwsGlueArgs();
        }

        public Builder(AwsIntegrationsAwsGlueArgs defaults) {
            $ = new AwsIntegrationsAwsGlueArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AwsIntegrationsAwsGlueArgs build() {
            return $;
        }
    }
