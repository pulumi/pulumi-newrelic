...
public final class AwsIntegrationsAwsNeptuneArgs extends com.pulumi.resources.ResourceArgs {

    public static final AwsIntegrationsAwsNeptuneArgs Empty = new AwsIntegrationsAwsNeptuneArgs();
    ...
    private AwsIntegrationsAwsNeptuneArgs() {}

    private AwsIntegrationsAwsNeptuneArgs(AwsIntegrationsAwsNeptuneArgs $) {
    ...
    public static Builder builder(AwsIntegrationsAwsNeptuneArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AwsIntegrationsAwsNeptuneArgs();
        }

        public Builder(AwsIntegrationsAwsNeptuneArgs defaults) {
            $ = new AwsIntegrationsAwsNeptuneArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AwsIntegrationsAwsNeptuneArgs build() {
            return $;
        }
    }
