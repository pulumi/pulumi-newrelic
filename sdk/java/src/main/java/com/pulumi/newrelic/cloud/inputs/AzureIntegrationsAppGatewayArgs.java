...
public final class AzureIntegrationsAppGatewayArgs extends com.pulumi.resources.ResourceArgs {

    public static final AzureIntegrationsAppGatewayArgs Empty = new AzureIntegrationsAppGatewayArgs();
    ...
    private AzureIntegrationsAppGatewayArgs() {}

    private AzureIntegrationsAppGatewayArgs(AzureIntegrationsAppGatewayArgs $) {
    ...
    public static Builder builder(AzureIntegrationsAppGatewayArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AzureIntegrationsAppGatewayArgs();
        }

        public Builder(AzureIntegrationsAppGatewayArgs defaults) {
            $ = new AzureIntegrationsAppGatewayArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AzureIntegrationsAppGatewayArgs build() {
            return $;
        }
    }
