...
public final class AzureIntegrationsContainersArgs extends com.pulumi.resources.ResourceArgs {

    public static final AzureIntegrationsContainersArgs Empty = new AzureIntegrationsContainersArgs();
    ...
    private AzureIntegrationsContainersArgs() {}

    private AzureIntegrationsContainersArgs(AzureIntegrationsContainersArgs $) {
    ...
    public static Builder builder(AzureIntegrationsContainersArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AzureIntegrationsContainersArgs();
        }

        public Builder(AzureIntegrationsContainersArgs defaults) {
            $ = new AzureIntegrationsContainersArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AzureIntegrationsContainersArgs build() {
            return $;
        }
    }
