...
@CustomType
public final class AzureIntegrationsLogicApps {
    /**
    ...
    private AzureIntegrationsLogicApps() {}
    /**
     * @return The data polling interval in seconds
     * 
     */
    ...
    public static Builder builder(AzureIntegrationsLogicApps defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> resourceGroups;
        public Builder() {}
        public Builder(AzureIntegrationsLogicApps defaults) {
        ...
        public AzureIntegrationsLogicApps build() {
            final var _resultValue = new AzureIntegrationsLogicApps();
