...
@CustomType
public final class InfraAlertConditionWarning {
    ...
    public static Builder builder(InfraAlertConditionWarning defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Double value;
        public Builder() {}
        public Builder(InfraAlertConditionWarning defaults) {
