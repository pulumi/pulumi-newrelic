...
public final class AwsIntegrationsXRayArgs extends com.pulumi.resources.ResourceArgs {

    public static final AwsIntegrationsXRayArgs Empty = new AwsIntegrationsXRayArgs();
    ...
    private AwsIntegrationsXRayArgs() {}

    private AwsIntegrationsXRayArgs(AwsIntegrationsXRayArgs $) {
    ...
    public static Builder builder(AwsIntegrationsXRayArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AwsIntegrationsXRayArgs();
        }

        public Builder(AwsIntegrationsXRayArgs defaults) {
            $ = new AwsIntegrationsXRayArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AwsIntegrationsXRayArgs build() {
            return $;
        }
    }
