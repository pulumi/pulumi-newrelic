...
public final class OneDashboardPageWidgetMarkdownDataFormatArgs extends com.pulumi.resources.ResourceArgs {

    public static final OneDashboardPageWidgetMarkdownDataFormatArgs Empty = new OneDashboardPageWidgetMarkdownDataFormatArgs();
    ...
    private OneDashboardPageWidgetMarkdownDataFormatArgs() {}

    private OneDashboardPageWidgetMarkdownDataFormatArgs(OneDashboardPageWidgetMarkdownDataFormatArgs $) {
        this.format = $.format;
        this.name = $.name;
    ...
    public static Builder builder(OneDashboardPageWidgetMarkdownDataFormatArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new OneDashboardPageWidgetMarkdownDataFormatArgs();
        }

        public Builder(OneDashboardPageWidgetMarkdownDataFormatArgs defaults) {
            $ = new OneDashboardPageWidgetMarkdownDataFormatArgs(Objects.requireNonNull(defaults));
        }
        ...
        public OneDashboardPageWidgetMarkdownDataFormatArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("OneDashboardPageWidgetMarkdownDataFormatArgs", "name");
            }
            if ($.type == null) {
                throw new MissingRequiredPropertyException("OneDashboardPageWidgetMarkdownDataFormatArgs", "type");
            }
            return $;
        }
    }
