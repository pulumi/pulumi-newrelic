...
@CustomType
public final class AwsIntegrationsAwsAutoDiscovery {
    /**
    ...
    public static Builder builder(AwsIntegrationsAwsAutoDiscovery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer metricsPollingInterval;
        public Builder() {}
        public Builder(AwsIntegrationsAwsAutoDiscovery defaults) {
        ...
        public AwsIntegrationsAwsAutoDiscovery build() {
            final var _resultValue = new AwsIntegrationsAwsAutoDiscovery();
