...
@CustomType
public final class GcpIntegrationsKubernetes {
    /**
    ...
    public static Builder builder(GcpIntegrationsKubernetes defaults) {
    ...
    public static final class Builder {
        private @Nullable Integer metricsPollingInterval;
        public Builder() {}
        public Builder(GcpIntegrationsKubernetes defaults) {
