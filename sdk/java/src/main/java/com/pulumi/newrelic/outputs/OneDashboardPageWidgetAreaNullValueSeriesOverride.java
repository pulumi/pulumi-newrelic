...
@CustomType
public final class OneDashboardPageWidgetAreaNullValueSeriesOverride {
    /**
    ...
    public static Builder builder(OneDashboardPageWidgetAreaNullValueSeriesOverride defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String seriesName;
        public Builder() {}
        public Builder(OneDashboardPageWidgetAreaNullValueSeriesOverride defaults) {
