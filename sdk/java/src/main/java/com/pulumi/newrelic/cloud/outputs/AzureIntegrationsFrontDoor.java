...
@CustomType
public final class AzureIntegrationsFrontDoor {
    /**
    ...
    private AzureIntegrationsFrontDoor() {}
    /**
     * @return The data polling interval in seconds.
     * 
     */
    ...
    public static Builder builder(AzureIntegrationsFrontDoor defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> resourceGroups;
        public Builder() {}
        public Builder(AzureIntegrationsFrontDoor defaults) {
