...
@CustomType
public final class AzureIntegrationsLoadBalancer {
    /**
    ...
    private AzureIntegrationsLoadBalancer() {}
    /**
     * @return The data polling interval in seconds.
     * 
     */
    ...
    public static Builder builder(AzureIntegrationsLoadBalancer defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> resourceGroups;
        public Builder() {}
        public Builder(AzureIntegrationsLoadBalancer defaults) {
        ...
        public AzureIntegrationsLoadBalancer build() {
            final var _resultValue = new AzureIntegrationsLoadBalancer();
