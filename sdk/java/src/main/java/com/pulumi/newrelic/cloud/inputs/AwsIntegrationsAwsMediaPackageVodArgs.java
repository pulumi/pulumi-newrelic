...
public final class AwsIntegrationsAwsMediaPackageVodArgs extends com.pulumi.resources.ResourceArgs {

    public static final AwsIntegrationsAwsMediaPackageVodArgs Empty = new AwsIntegrationsAwsMediaPackageVodArgs();
    ...
    private AwsIntegrationsAwsMediaPackageVodArgs() {}

    private AwsIntegrationsAwsMediaPackageVodArgs(AwsIntegrationsAwsMediaPackageVodArgs $) {
    ...
    public static Builder builder(AwsIntegrationsAwsMediaPackageVodArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AwsIntegrationsAwsMediaPackageVodArgs();
        }

        public Builder(AwsIntegrationsAwsMediaPackageVodArgs defaults) {
            $ = new AwsIntegrationsAwsMediaPackageVodArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AwsIntegrationsAwsMediaPackageVodArgs build() {
            return $;
        }
    }
