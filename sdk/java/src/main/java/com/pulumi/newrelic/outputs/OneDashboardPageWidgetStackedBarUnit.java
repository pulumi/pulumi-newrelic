...
import com.pulumi.newrelic.outputs.OneDashboardPageWidgetStackedBarUnitSeriesOverride;
...
public final class OneDashboardPageWidgetStackedBarUnit {
    ...
    public static Builder builder(OneDashboardPageWidgetStackedBarUnit defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String unit;
        public Builder() {}
        public Builder(OneDashboardPageWidgetStackedBarUnit defaults) {
        ...
        @CustomType.Setter
        public Builder seriesOverrides(@Nullable List<OneDashboardPageWidgetStackedBarUnitSeriesOverride> seriesOverrides) {

            this.seriesOverrides = seriesOverrides;
            return this;
        }
        public Builder seriesOverrides(OneDashboardPageWidgetStackedBarUnitSeriesOverride... seriesOverrides) {
