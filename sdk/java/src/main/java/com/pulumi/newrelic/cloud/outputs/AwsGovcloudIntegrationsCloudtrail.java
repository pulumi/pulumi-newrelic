...
@CustomType
public final class AwsGovcloudIntegrationsCloudtrail {
    /**
    ...
    private AwsGovcloudIntegrationsCloudtrail() {}
    /**
     * @return Specify each AWS region that includes the resources that you want to monitor
     * 
     */
    ...
    public static Builder builder(AwsGovcloudIntegrationsCloudtrail defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer metricsPollingInterval;
        public Builder() {}
        public Builder(AwsGovcloudIntegrationsCloudtrail defaults) {
