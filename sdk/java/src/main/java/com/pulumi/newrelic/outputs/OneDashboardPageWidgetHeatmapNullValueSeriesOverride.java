...
@CustomType
public final class OneDashboardPageWidgetHeatmapNullValueSeriesOverride {
    /**
    ...
    public static Builder builder(OneDashboardPageWidgetHeatmapNullValueSeriesOverride defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String seriesName;
        public Builder() {}
        public Builder(OneDashboardPageWidgetHeatmapNullValueSeriesOverride defaults) {
        ...
        public OneDashboardPageWidgetHeatmapNullValueSeriesOverride build() {
            final var _resultValue = new OneDashboardPageWidgetHeatmapNullValueSeriesOverride();
