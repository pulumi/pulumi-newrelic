...
import com.pulumi.newrelic.inputs.OneDashboardPageWidgetHistogramChartStylesArgs;
...
import com.pulumi.newrelic.inputs.OneDashboardPageWidgetHistogramUnitArgs;
...
public final class OneDashboardPageWidgetHistogramArgs extends com.pulumi.resources.ResourceArgs {

    public static final OneDashboardPageWidgetHistogramArgs Empty = new OneDashboardPageWidgetHistogramArgs();
    ...
    private @Nullable Output<OneDashboardPageWidgetHistogramChartStylesArgs> chartStyles;
     ...
     * 
     */
    public Optional<Output<OneDashboardPageWidgetHistogramChartStylesArgs>> chartStyles() {
     ...
     */
    @Import(name="colors")
    private @Nullable Output<List<OneDashboardPageWidgetHistogramColorArgs>> colors;
     ...
     * 
     */
    public Optional<Output<List<OneDashboardPageWidgetHistogramColorArgs>>> colors() {
    ...
    private @Nullable Output<OneDashboardPageWidgetHistogramInitialSortingArgs> initialSorting;
     ...
     * 
     */
    public Optional<Output<OneDashboardPageWidgetHistogramInitialSortingArgs>> initialSorting() {
    ...
    private @Nullable Output<List<OneDashboardPageWidgetHistogramNullValueArgs>> nullValues;

    /**
     * @return (Optional) A nested block that describes a Null Values. See Nested Null Values blocks below for details.
     * 
     */
    public Optional<Output<List<OneDashboardPageWidgetHistogramNullValueArgs>>> nullValues() {
     ...
     */
    @Import(name="units")
    private @Nullable Output<List<OneDashboardPageWidgetHistogramUnitArgs>> units;

    /**
     * @return (Optional) A nested block that describes units on your Y axis. See Nested Units blocks below for details.
     * 
     */
    public Optional<Output<List<OneDashboardPageWidgetHistogramUnitArgs>>> units() {
    ...
    private OneDashboardPageWidgetHistogramArgs() {}
    ...
    public static Builder builder(OneDashboardPageWidgetHistogramArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new OneDashboardPageWidgetHistogramArgs();
        }

        public Builder(OneDashboardPageWidgetHistogramArgs defaults) {
            $ = new OneDashboardPageWidgetHistogramArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder chartStyles(@Nullable Output<OneDashboardPageWidgetHistogramChartStylesArgs> chartStyles) {
         ...
         * 
         */
        public Builder chartStyles(OneDashboardPageWidgetHistogramChartStylesArgs chartStyles) {
         ...
         * 
         */
        public Builder colors(@Nullable Output<List<OneDashboardPageWidgetHistogramColorArgs>> colors) {
            $.colors = colors;
            return this;
        }
         ...
         * 
         */
        public Builder colors(List<OneDashboardPageWidgetHistogramColorArgs> colors) {
         ...
         * 
         */
        public Builder colors(OneDashboardPageWidgetHistogramColorArgs... colors) {
         ...
         * 
         */
        public Builder initialSorting(@Nullable Output<OneDashboardPageWidgetHistogramInitialSortingArgs> initialSorting) {
         ...
         * 
         */
        public Builder initialSorting(OneDashboardPageWidgetHistogramInitialSortingArgs initialSorting) {
         ...
         * 
         */
        public Builder nrqlQueries(Output<List<OneDashboardPageWidgetHistogramNrqlQueryArgs>> nrqlQueries) {
         ...
         * 
         */
        public Builder nrqlQueries(List<OneDashboardPageWidgetHistogramNrqlQueryArgs> nrqlQueries) {
         ...
         * 
         */
        public Builder nrqlQueries(OneDashboardPageWidgetHistogramNrqlQueryArgs... nrqlQueries) {
         ...
         * 
         */
        public Builder nullValues(@Nullable Output<List<OneDashboardPageWidgetHistogramNullValueArgs>> nullValues) {
         ...
         * 
         */
        public Builder nullValues(List<OneDashboardPageWidgetHistogramNullValueArgs> nullValues) {
         ...
         * 
         */
        public Builder nullValues(OneDashboardPageWidgetHistogramNullValueArgs... nullValues) {
         ...
         * 
         */
        public Builder units(@Nullable Output<List<OneDashboardPageWidgetHistogramUnitArgs>> units) {
            $.units = units;
            return this;
        }
         ...
         * 
         */
        public Builder units(List<OneDashboardPageWidgetHistogramUnitArgs> units) {
         ...
         * 
         */
        public Builder units(OneDashboardPageWidgetHistogramUnitArgs... units) {
        ...
        public OneDashboardPageWidgetHistogramArgs build() {
            if ($.column == null) {
                throw new MissingRequiredPropertyException("OneDashboardPageWidgetHistogramArgs", "column");
            }
            if ($.nrqlQueries == null) {
                throw new MissingRequiredPropertyException("OneDashboardPageWidgetHistogramArgs", "nrqlQueries");
            }
            if ($.row == null) {
                throw new MissingRequiredPropertyException("OneDashboardPageWidgetHistogramArgs", "row");
            }
            if ($.title == null) {
                throw new MissingRequiredPropertyException("OneDashboardPageWidgetHistogramArgs", "title");
            }
            return $;
        }
    }
