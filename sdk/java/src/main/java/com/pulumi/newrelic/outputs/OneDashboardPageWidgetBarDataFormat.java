...
@CustomType
public final class OneDashboardPageWidgetBarDataFormat {
    /**
    ...
    private OneDashboardPageWidgetBarDataFormat() {}
    /**
     * @return (Optional) This attribute is provided when the `name` is that of a column comprising date/time values and the `type` attribute is set to `custom` defining the specific date format to be applied to your data.
     * 
     */
    ...
    public static Builder builder(OneDashboardPageWidgetBarDataFormat defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(OneDashboardPageWidgetBarDataFormat defaults) {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("OneDashboardPageWidgetBarDataFormat", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("OneDashboardPageWidgetBarDataFormat", "type");
            }
            this.type = type;
            return this;
        }
        public OneDashboardPageWidgetBarDataFormat build() {
            final var _resultValue = new OneDashboardPageWidgetBarDataFormat();
