...
@CustomType
public final class OneDashboardPageWidgetTableNullValueSeriesOverride {
    /**
    ...
    private OneDashboardPageWidgetTableNullValueSeriesOverride() {}
    /**
     * @return Choose an option in displaying null values. Accepted values are `default`, `remove`, `preserve`, or `zero`.
     * 
     */
    ...
    public static Builder builder(OneDashboardPageWidgetTableNullValueSeriesOverride defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String seriesName;
        public Builder() {}
        public Builder(OneDashboardPageWidgetTableNullValueSeriesOverride defaults) {
        ...
        public OneDashboardPageWidgetTableNullValueSeriesOverride build() {
            final var _resultValue = new OneDashboardPageWidgetTableNullValueSeriesOverride();
