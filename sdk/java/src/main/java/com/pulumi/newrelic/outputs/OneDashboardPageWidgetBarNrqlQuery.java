...
@CustomType
public final class OneDashboardPageWidgetBarNrqlQuery {
    /**
    ...
    private OneDashboardPageWidgetBarNrqlQuery() {}
    /**
     * @return Determines the New Relic account where the dashboard will be created. Defaults to the account associated with the API key used.
     * 
     */
    ...
    public static Builder builder(OneDashboardPageWidgetBarNrqlQuery defaults) {
    ...
    public static final class Builder {
        ...
        public Builder query(String query) {
            if (query == null) {
              throw new MissingRequiredPropertyException("OneDashboardPageWidgetBarNrqlQuery", "query");
            }
            this.query = query;
            return this;
        }
        public OneDashboardPageWidgetBarNrqlQuery build() {
            final var _resultValue = new OneDashboardPageWidgetBarNrqlQuery();
