...
public final class AwsGovcloudIntegrationsCloudtrailArgs extends com.pulumi.resources.ResourceArgs {

    public static final AwsGovcloudIntegrationsCloudtrailArgs Empty = new AwsGovcloudIntegrationsCloudtrailArgs();
    ...
    private AwsGovcloudIntegrationsCloudtrailArgs() {}

    private AwsGovcloudIntegrationsCloudtrailArgs(AwsGovcloudIntegrationsCloudtrailArgs $) {
    ...
    public static Builder builder(AwsGovcloudIntegrationsCloudtrailArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AwsGovcloudIntegrationsCloudtrailArgs();
        }

        public Builder(AwsGovcloudIntegrationsCloudtrailArgs defaults) {
            $ = new AwsGovcloudIntegrationsCloudtrailArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AwsGovcloudIntegrationsCloudtrailArgs build() {
            return $;
        }
    }
