...
public final class AwsIntegrationsAwsAthenaArgs extends com.pulumi.resources.ResourceArgs {

    public static final AwsIntegrationsAwsAthenaArgs Empty = new AwsIntegrationsAwsAthenaArgs();
    ...
    private AwsIntegrationsAwsAthenaArgs() {}

    private AwsIntegrationsAwsAthenaArgs(AwsIntegrationsAwsAthenaArgs $) {
    ...
    public static Builder builder(AwsIntegrationsAwsAthenaArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AwsIntegrationsAwsAthenaArgs();
        }

        public Builder(AwsIntegrationsAwsAthenaArgs defaults) {
            $ = new AwsIntegrationsAwsAthenaArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AwsIntegrationsAwsAthenaArgs build() {
            return $;
        }
    }
