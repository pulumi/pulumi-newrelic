...
@CustomType
public final class OneDashboardPageWidgetHeatmapUnitSeriesOverride {
    /**
     * @return Series name
     * 
     */
    ...
    public static Builder builder(OneDashboardPageWidgetHeatmapUnitSeriesOverride defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String unit;
        public Builder() {}
        public Builder(OneDashboardPageWidgetHeatmapUnitSeriesOverride defaults) {
