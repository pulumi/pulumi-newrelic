...
@CustomType
public final class GcpIntegrationsAlloyDb {
    /**
    ...
    private GcpIntegrationsAlloyDb() {}
    /**
     * @return the data polling interval in seconds
     * 
     */
    ...
    public static Builder builder(GcpIntegrationsAlloyDb defaults) {
    ...
    public static final class Builder {
        private @Nullable Integer metricsPollingInterval;
        public Builder() {}
        public Builder(GcpIntegrationsAlloyDb defaults) {
