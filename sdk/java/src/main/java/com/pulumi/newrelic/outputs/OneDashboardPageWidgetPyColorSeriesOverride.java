...
@CustomType
public final class OneDashboardPageWidgetPyColorSeriesOverride {
    /**
    ...
    public static Builder builder(OneDashboardPageWidgetPyColorSeriesOverride defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String seriesName;
        public Builder() {}
        public Builder(OneDashboardPageWidgetPyColorSeriesOverride defaults) {
        ...
        public OneDashboardPageWidgetPyColorSeriesOverride build() {
            final var _resultValue = new OneDashboardPageWidgetPyColorSeriesOverride();
