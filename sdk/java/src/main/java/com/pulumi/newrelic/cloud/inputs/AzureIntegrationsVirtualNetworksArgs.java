...
public final class AzureIntegrationsVirtualNetworksArgs extends com.pulumi.resources.ResourceArgs {

    public static final AzureIntegrationsVirtualNetworksArgs Empty = new AzureIntegrationsVirtualNetworksArgs();
    ...
    private AzureIntegrationsVirtualNetworksArgs() {}

    private AzureIntegrationsVirtualNetworksArgs(AzureIntegrationsVirtualNetworksArgs $) {
    ...
    public static Builder builder(AzureIntegrationsVirtualNetworksArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AzureIntegrationsVirtualNetworksArgs();
        }

        public Builder(AzureIntegrationsVirtualNetworksArgs defaults) {
            $ = new AzureIntegrationsVirtualNetworksArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AzureIntegrationsVirtualNetworksArgs build() {
            return $;
        }
    }
