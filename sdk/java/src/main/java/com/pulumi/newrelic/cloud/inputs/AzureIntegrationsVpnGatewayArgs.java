...
public final class AzureIntegrationsVpnGatewayArgs extends com.pulumi.resources.ResourceArgs {

    public static final AzureIntegrationsVpnGatewayArgs Empty = new AzureIntegrationsVpnGatewayArgs();
    ...
    private AzureIntegrationsVpnGatewayArgs() {}

    private AzureIntegrationsVpnGatewayArgs(AzureIntegrationsVpnGatewayArgs $) {
    ...
    public static Builder builder(AzureIntegrationsVpnGatewayArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AzureIntegrationsVpnGatewayArgs();
        }

        public Builder(AzureIntegrationsVpnGatewayArgs defaults) {
            $ = new AzureIntegrationsVpnGatewayArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AzureIntegrationsVpnGatewayArgs build() {
            return $;
        }
    }
