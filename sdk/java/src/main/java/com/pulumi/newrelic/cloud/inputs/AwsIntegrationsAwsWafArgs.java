...
public final class AwsIntegrationsAwsWafArgs extends com.pulumi.resources.ResourceArgs {

    public static final AwsIntegrationsAwsWafArgs Empty = new AwsIntegrationsAwsWafArgs();
    ...
    private AwsIntegrationsAwsWafArgs() {}

    private AwsIntegrationsAwsWafArgs(AwsIntegrationsAwsWafArgs $) {
    ...
    public static Builder builder(AwsIntegrationsAwsWafArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AwsIntegrationsAwsWafArgs();
        }

        public Builder(AwsIntegrationsAwsWafArgs defaults) {
            $ = new AwsIntegrationsAwsWafArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AwsIntegrationsAwsWafArgs build() {
            return $;
        }
    }
