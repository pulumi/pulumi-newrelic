...
@CustomType
public final class AzureIntegrationsSqlManaged {
    /**
    ...
    private AzureIntegrationsSqlManaged() {}
    /**
     * @return The data polling interval in seconds
     * 
     */
    ...
    public static Builder builder(AzureIntegrationsSqlManaged defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> resourceGroups;
        public Builder() {}
        public Builder(AzureIntegrationsSqlManaged defaults) {
        ...
        public AzureIntegrationsSqlManaged build() {
            final var _resultValue = new AzureIntegrationsSqlManaged();
