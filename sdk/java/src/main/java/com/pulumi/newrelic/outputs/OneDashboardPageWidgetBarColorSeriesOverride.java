...
@CustomType
public final class OneDashboardPageWidgetBarColorSeriesOverride {
    /**
    ...
    private OneDashboardPageWidgetBarColorSeriesOverride() {}
    /**
     * @return (Optional) Choose a color to customize the color of your charts per series in area, bar, line, pie, and stacked bar charts. Accepted values are RGB, HEX, or HSL code.
     * 
     */
    ...
    public static Builder builder(OneDashboardPageWidgetBarColorSeriesOverride defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String seriesName;
        public Builder() {}
        public Builder(OneDashboardPageWidgetBarColorSeriesOverride defaults) {
        ...
        public OneDashboardPageWidgetBarColorSeriesOverride build() {
            final var _resultValue = new OneDashboardPageWidgetBarColorSeriesOverride();
