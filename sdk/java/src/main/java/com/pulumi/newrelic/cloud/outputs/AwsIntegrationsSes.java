...
@CustomType
public final class AwsIntegrationsSes {
    /**
    ...
    public static Builder builder(AwsIntegrationsSes defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer metricsPollingInterval;
        public Builder() {}
        public Builder(AwsIntegrationsSes defaults) {
        ...
        public AwsIntegrationsSes build() {
            final var _resultValue = new AwsIntegrationsSes();
