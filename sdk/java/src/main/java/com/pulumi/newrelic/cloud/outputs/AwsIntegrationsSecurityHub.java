...
@CustomType
public final class AwsIntegrationsSecurityHub {
    /**
    ...
    private AwsIntegrationsSecurityHub() {}
    /**
     * @return Specify each AWS region that includes the resources that you want to monitor.
     * 
     */
    ...
    public static Builder builder(AwsIntegrationsSecurityHub defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer metricsPollingInterval;
        public Builder() {}
        public Builder(AwsIntegrationsSecurityHub defaults) {
        ...
        public AwsIntegrationsSecurityHub build() {
            final var _resultValue = new AwsIntegrationsSecurityHub();
