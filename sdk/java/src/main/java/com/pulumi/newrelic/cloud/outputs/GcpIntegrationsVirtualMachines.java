...
@CustomType
public final class GcpIntegrationsVirtualMachines {
    /**
    ...
    public static Builder builder(GcpIntegrationsVirtualMachines defaults) {
    ...
    public static final class Builder {
        private @Nullable Integer metricsPollingInterval;
        public Builder() {}
        public Builder(GcpIntegrationsVirtualMachines defaults) {
