...
@CustomType
public final class OneDashboardPageWidgetBillboardDataFormat {
    /**
    ...
    private OneDashboardPageWidgetBillboardDataFormat() {}
    /**
     * @return (Optional) This attribute is provided when the `name` is that of a column comprising date/time values and the `type` attribute is set to `custom` defining the specific date format to be applied to your data.
     * 
     */
    ...
    public static Builder builder(OneDashboardPageWidgetBillboardDataFormat defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(OneDashboardPageWidgetBillboardDataFormat defaults) {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("OneDashboardPageWidgetBillboardDataFormat", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("OneDashboardPageWidgetBillboardDataFormat", "type");
            }
            this.type = type;
            return this;
        }
        public OneDashboardPageWidgetBillboardDataFormat build() {
            final var _resultValue = new OneDashboardPageWidgetBillboardDataFormat();
