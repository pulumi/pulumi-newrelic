...
@CustomType
public final class AwsEuSovereignIntegrationsXRay {
    /**
    ...
    private AwsEuSovereignIntegrationsXRay() {}
    /**
     * @return Specify each AWS region that includes the resources that you want to monitor
     * 
     */
    ...
    public static Builder builder(AwsEuSovereignIntegrationsXRay defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer metricsPollingInterval;
        public Builder() {}
        public Builder(AwsEuSovereignIntegrationsXRay defaults) {
        ...
        public AwsEuSovereignIntegrationsXRay build() {
            final var _resultValue = new AwsEuSovereignIntegrationsXRay();
