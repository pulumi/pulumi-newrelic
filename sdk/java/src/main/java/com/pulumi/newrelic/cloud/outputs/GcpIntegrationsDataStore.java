...
@CustomType
public final class GcpIntegrationsDataStore {
    /**
    ...
    public static Builder builder(GcpIntegrationsDataStore defaults) {
    ...
    public static final class Builder {
        private @Nullable Integer metricsPollingInterval;
        public Builder() {}
        public Builder(GcpIntegrationsDataStore defaults) {
