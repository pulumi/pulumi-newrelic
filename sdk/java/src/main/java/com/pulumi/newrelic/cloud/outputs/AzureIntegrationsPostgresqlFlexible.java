...
@CustomType
public final class AzureIntegrationsPostgresqlFlexible {
    /**
    ...
    private AzureIntegrationsPostgresqlFlexible() {}
    /**
     * @return The data polling interval in seconds.
     * 
     */
    ...
    public static Builder builder(AzureIntegrationsPostgresqlFlexible defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> resourceGroups;
        public Builder() {}
        public Builder(AzureIntegrationsPostgresqlFlexible defaults) {
