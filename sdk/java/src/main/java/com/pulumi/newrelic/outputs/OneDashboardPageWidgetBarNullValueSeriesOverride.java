...
@CustomType
public final class OneDashboardPageWidgetBarNullValueSeriesOverride {
    /**
    ...
    private OneDashboardPageWidgetBarNullValueSeriesOverride() {}
    /**
     * @return Choose an option in displaying null values. Accepted values are `default`, `remove`, `preserve`, or `zero`.
     * 
     */
    ...
    public static Builder builder(OneDashboardPageWidgetBarNullValueSeriesOverride defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String seriesName;
        public Builder() {}
        public Builder(OneDashboardPageWidgetBarNullValueSeriesOverride defaults) {
        ...
        public OneDashboardPageWidgetBarNullValueSeriesOverride build() {
            final var _resultValue = new OneDashboardPageWidgetBarNullValueSeriesOverride();
