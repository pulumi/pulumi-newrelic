...
@CustomType
public final class ScriptMonitorLocationPrivate {
    /**
    ...
    public static Builder builder(ScriptMonitorLocationPrivate defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String vsePassword;
        public Builder() {}
        public Builder(ScriptMonitorLocationPrivate defaults) {
