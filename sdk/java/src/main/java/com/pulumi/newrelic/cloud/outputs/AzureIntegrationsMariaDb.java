...
@CustomType
public final class AzureIntegrationsMariaDb {
    /**
    ...
    private AzureIntegrationsMariaDb() {}
    /**
     * @return The data polling interval in seconds.
     * 
     */
    ...
    public static Builder builder(AzureIntegrationsMariaDb defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> resourceGroups;
        public Builder() {}
        public Builder(AzureIntegrationsMariaDb defaults) {
