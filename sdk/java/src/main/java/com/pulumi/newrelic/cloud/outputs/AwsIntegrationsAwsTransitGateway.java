...
@CustomType
public final class AwsIntegrationsAwsTransitGateway {
    /**
    ...
    private AwsIntegrationsAwsTransitGateway() {}
    /**
     * @return Specify each AWS region that includes the resources that you want to monitor.
     * &lt;/details&gt;
     * 
    ...
    public static Builder builder(AwsIntegrationsAwsTransitGateway defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer metricsPollingInterval;
        public Builder() {}
        public Builder(AwsIntegrationsAwsTransitGateway defaults) {
