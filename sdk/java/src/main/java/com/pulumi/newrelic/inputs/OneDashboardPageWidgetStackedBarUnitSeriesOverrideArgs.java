...
public final class OneDashboardPageWidgetStackedBarUnitSeriesOverrideArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private OneDashboardPageWidgetStackedBarUnitSeriesOverrideArgs() {}

    private OneDashboardPageWidgetStackedBarUnitSeriesOverrideArgs(OneDashboardPageWidgetStackedBarUnitSeriesOverrideArgs $) {
    ...
    public static Builder builder(OneDashboardPageWidgetStackedBarUnitSeriesOverrideArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new OneDashboardPageWidgetStackedBarUnitSeriesOverrideArgs();
        }

        public Builder(OneDashboardPageWidgetStackedBarUnitSeriesOverrideArgs defaults) {
        ...
        public OneDashboardPageWidgetStackedBarUnitSeriesOverrideArgs build() {
            return $;
        }
    }
