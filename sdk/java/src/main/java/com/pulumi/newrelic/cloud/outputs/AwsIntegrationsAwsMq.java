...
@CustomType
public final class AwsIntegrationsAwsMq {
    /**
    ...
    public static Builder builder(AwsIntegrationsAwsMq defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer metricsPollingInterval;
        public Builder() {}
        public Builder(AwsIntegrationsAwsMq defaults) {
        ...
        public AwsIntegrationsAwsMq build() {
            final var _resultValue = new AwsIntegrationsAwsMq();
