...
import com.pulumi.newrelic.inputs.OneDashboardPageWidgetMarkdownChartStylesArgs;
import com.pulumi.newrelic.inputs.OneDashboardPageWidgetMarkdownColorArgs;
import com.pulumi.newrelic.inputs.OneDashboardPageWidgetMarkdownDataFormatArgs;
import com.pulumi.newrelic.inputs.OneDashboardPageWidgetMarkdownInitialSortingArgs;
...
public final class OneDashboardPageWidgetMarkdownArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<OneDashboardPageWidgetMarkdownChartStylesArgs> chartStyles;
     ...
     * 
     */
    public Optional<Output<OneDashboardPageWidgetMarkdownChartStylesArgs>> chartStyles() {
    ...
    private @Nullable Output<List<OneDashboardPageWidgetMarkdownDataFormatArgs>> dataFormats;

    /**
     * @return (Optional) A nested block that describes data format. See Nested dataFormat blocks below for details.
     * 
     */
    public Optional<Output<List<OneDashboardPageWidgetMarkdownDataFormatArgs>>> dataFormats() {
    ...
    private @Nullable Output<OneDashboardPageWidgetMarkdownInitialSortingArgs> initialSorting;
     ...
     * 
     */
    public Optional<Output<OneDashboardPageWidgetMarkdownInitialSortingArgs>> initialSorting() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder chartStyles(@Nullable Output<OneDashboardPageWidgetMarkdownChartStylesArgs> chartStyles) {
         ...
         * 
         */
        public Builder chartStyles(OneDashboardPageWidgetMarkdownChartStylesArgs chartStyles) {
         ...
         * 
         */
        public Builder dataFormats(@Nullable Output<List<OneDashboardPageWidgetMarkdownDataFormatArgs>> dataFormats) {
         ...
         * 
         */
        public Builder dataFormats(List<OneDashboardPageWidgetMarkdownDataFormatArgs> dataFormats) {
         ...
         * 
         */
        public Builder dataFormats(OneDashboardPageWidgetMarkdownDataFormatArgs... dataFormats) {
         ...
         * 
         */
        public Builder initialSorting(@Nullable Output<OneDashboardPageWidgetMarkdownInitialSortingArgs> initialSorting) {
         ...
         * 
         */
        public Builder initialSorting(OneDashboardPageWidgetMarkdownInitialSortingArgs initialSorting) {
