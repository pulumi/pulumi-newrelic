...
public final class AwsIntegrationsEcsArgs extends com.pulumi.resources.ResourceArgs {

    public static final AwsIntegrationsEcsArgs Empty = new AwsIntegrationsEcsArgs();
    ...
    private AwsIntegrationsEcsArgs() {}

    private AwsIntegrationsEcsArgs(AwsIntegrationsEcsArgs $) {
    ...
    public static Builder builder(AwsIntegrationsEcsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AwsIntegrationsEcsArgs();
        }

        public Builder(AwsIntegrationsEcsArgs defaults) {
            $ = new AwsIntegrationsEcsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AwsIntegrationsEcsArgs build() {
            return $;
        }
    }
