...
@CustomType
public final class AwsIntegrationsHealth {
    /**
    ...
    public static Builder builder(AwsIntegrationsHealth defaults) {
    ...
    public static final class Builder {
        private @Nullable Integer metricsPollingInterval;
        public Builder() {}
        public Builder(AwsIntegrationsHealth defaults) {
