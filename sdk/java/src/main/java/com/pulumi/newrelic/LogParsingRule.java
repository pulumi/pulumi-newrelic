...
public class LogParsingRule extends com.pulumi.resources.CustomResource {
     ...
     */
    public LogParsingRule(java.lang.String name) {
     ...
     */
    public LogParsingRule(java.lang.String name, LogParsingRuleArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public LogParsingRule(java.lang.String name, LogParsingRuleArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("newrelic:index/logParsingRule:LogParsingRule", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private LogParsingRule(java.lang.String name, Output<java.lang.String> id, @Nullable LogParsingRuleState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("newrelic:index/logParsingRule:LogParsingRule", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static LogParsingRule get(java.lang.String name, Output<java.lang.String> id, @Nullable LogParsingRuleState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
