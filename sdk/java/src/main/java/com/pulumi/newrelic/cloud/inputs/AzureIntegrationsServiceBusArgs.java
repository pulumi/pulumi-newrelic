...
public final class AzureIntegrationsServiceBusArgs extends com.pulumi.resources.ResourceArgs {

    public static final AzureIntegrationsServiceBusArgs Empty = new AzureIntegrationsServiceBusArgs();
    ...
    private AzureIntegrationsServiceBusArgs() {}

    private AzureIntegrationsServiceBusArgs(AzureIntegrationsServiceBusArgs $) {
    ...
    public static Builder builder(AzureIntegrationsServiceBusArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AzureIntegrationsServiceBusArgs();
        }

        public Builder(AzureIntegrationsServiceBusArgs defaults) {
            $ = new AzureIntegrationsServiceBusArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AzureIntegrationsServiceBusArgs build() {
            return $;
        }
    }
