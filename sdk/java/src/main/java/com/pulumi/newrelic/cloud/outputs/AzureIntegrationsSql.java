...
@CustomType
public final class AzureIntegrationsSql {
    /**
    ...
    public static Builder builder(AzureIntegrationsSql defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> resourceGroups;
        public Builder() {}
        public Builder(AzureIntegrationsSql defaults) {
        ...
        public AzureIntegrationsSql build() {
            final var _resultValue = new AzureIntegrationsSql();
