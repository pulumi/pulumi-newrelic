...
public final class AwsIntegrationsIotArgs extends com.pulumi.resources.ResourceArgs {

    public static final AwsIntegrationsIotArgs Empty = new AwsIntegrationsIotArgs();
    ...
    private AwsIntegrationsIotArgs() {}

    private AwsIntegrationsIotArgs(AwsIntegrationsIotArgs $) {
    ...
    public static Builder builder(AwsIntegrationsIotArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AwsIntegrationsIotArgs();
        }

        public Builder(AwsIntegrationsIotArgs defaults) {
            $ = new AwsIntegrationsIotArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AwsIntegrationsIotArgs build() {
            return $;
        }
    }
