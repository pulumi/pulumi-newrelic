...
public final class OneDashboardPageWidgetHistogramDataFormatArgs extends com.pulumi.resources.ResourceArgs {

    public static final OneDashboardPageWidgetHistogramDataFormatArgs Empty = new OneDashboardPageWidgetHistogramDataFormatArgs();
    ...
    private OneDashboardPageWidgetHistogramDataFormatArgs() {}

    private OneDashboardPageWidgetHistogramDataFormatArgs(OneDashboardPageWidgetHistogramDataFormatArgs $) {
        this.format = $.format;
        this.name = $.name;
    ...
    public static Builder builder(OneDashboardPageWidgetHistogramDataFormatArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new OneDashboardPageWidgetHistogramDataFormatArgs();
        }

        public Builder(OneDashboardPageWidgetHistogramDataFormatArgs defaults) {
            $ = new OneDashboardPageWidgetHistogramDataFormatArgs(Objects.requireNonNull(defaults));
        }
        ...
        public OneDashboardPageWidgetHistogramDataFormatArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("OneDashboardPageWidgetHistogramDataFormatArgs", "name");
            }
            if ($.type == null) {
                throw new MissingRequiredPropertyException("OneDashboardPageWidgetHistogramDataFormatArgs", "type");
            }
            return $;
        }
    }
