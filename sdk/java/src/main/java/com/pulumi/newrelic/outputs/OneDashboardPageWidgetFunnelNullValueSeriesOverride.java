...
@CustomType
public final class OneDashboardPageWidgetFunnelNullValueSeriesOverride {
    /**
    ...
    private OneDashboardPageWidgetFunnelNullValueSeriesOverride() {}
    /**
     * @return Choose an option in displaying null values. Accepted values are `default`, `remove`, `preserve`, or `zero`.
     * 
     */
    ...
    public static Builder builder(OneDashboardPageWidgetFunnelNullValueSeriesOverride defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String seriesName;
        public Builder() {}
        public Builder(OneDashboardPageWidgetFunnelNullValueSeriesOverride defaults) {
        ...
        public OneDashboardPageWidgetFunnelNullValueSeriesOverride build() {
            final var _resultValue = new OneDashboardPageWidgetFunnelNullValueSeriesOverride();
