...
public final class OneDashboardPageWidgetFunnelDataFormatArgs extends com.pulumi.resources.ResourceArgs {

    public static final OneDashboardPageWidgetFunnelDataFormatArgs Empty = new OneDashboardPageWidgetFunnelDataFormatArgs();
    ...
    private OneDashboardPageWidgetFunnelDataFormatArgs() {}

    private OneDashboardPageWidgetFunnelDataFormatArgs(OneDashboardPageWidgetFunnelDataFormatArgs $) {
        this.format = $.format;
        this.name = $.name;
    ...
    public static Builder builder(OneDashboardPageWidgetFunnelDataFormatArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new OneDashboardPageWidgetFunnelDataFormatArgs();
        }

        public Builder(OneDashboardPageWidgetFunnelDataFormatArgs defaults) {
            $ = new OneDashboardPageWidgetFunnelDataFormatArgs(Objects.requireNonNull(defaults));
        }
        ...
        public OneDashboardPageWidgetFunnelDataFormatArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("OneDashboardPageWidgetFunnelDataFormatArgs", "name");
            }
            if ($.type == null) {
                throw new MissingRequiredPropertyException("OneDashboardPageWidgetFunnelDataFormatArgs", "type");
            }
            return $;
        }
    }
