...
public class DataPartitionRule extends com.pulumi.resources.CustomResource {
     ...
     */
    public DataPartitionRule(java.lang.String name) {
     ...
     */
    public DataPartitionRule(java.lang.String name, DataPartitionRuleArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public DataPartitionRule(java.lang.String name, DataPartitionRuleArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("newrelic:index/dataPartitionRule:DataPartitionRule", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private DataPartitionRule(java.lang.String name, Output<java.lang.String> id, @Nullable DataPartitionRuleState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("newrelic:index/dataPartitionRule:DataPartitionRule", name, state, makeResourceOptions(options, id), false);
    }

    private static DataPartitionRuleArgs makeArgs(DataPartitionRuleArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? DataPartitionRuleArgs.Empty : args;
    }
     ...
     */
    public static DataPartitionRule get(java.lang.String name, Output<java.lang.String> id, @Nullable DataPartitionRuleState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
