...
public final class OneDashboardPageWidgetBillboardNrqlQueryArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private OneDashboardPageWidgetBillboardNrqlQueryArgs() {}

    private OneDashboardPageWidgetBillboardNrqlQueryArgs(OneDashboardPageWidgetBillboardNrqlQueryArgs $) {
    ...
    public static Builder builder(OneDashboardPageWidgetBillboardNrqlQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new OneDashboardPageWidgetBillboardNrqlQueryArgs();
        }

        public Builder(OneDashboardPageWidgetBillboardNrqlQueryArgs defaults) {
            $ = new OneDashboardPageWidgetBillboardNrqlQueryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public OneDashboardPageWidgetBillboardNrqlQueryArgs build() {
            if ($.query == null) {
                throw new MissingRequiredPropertyException("OneDashboardPageWidgetBillboardNrqlQueryArgs", "query");
            }
            return $;
        }
    }
