...
public final class AzureIntegrationsVmsArgs extends com.pulumi.resources.ResourceArgs {

    public static final AzureIntegrationsVmsArgs Empty = new AzureIntegrationsVmsArgs();
    ...
    private AzureIntegrationsVmsArgs() {}

    private AzureIntegrationsVmsArgs(AzureIntegrationsVmsArgs $) {
    ...
    public static Builder builder(AzureIntegrationsVmsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AzureIntegrationsVmsArgs();
        }

        public Builder(AzureIntegrationsVmsArgs defaults) {
            $ = new AzureIntegrationsVmsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AzureIntegrationsVmsArgs build() {
            return $;
        }
    }
