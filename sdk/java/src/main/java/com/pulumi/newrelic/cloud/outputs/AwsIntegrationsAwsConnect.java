...
@CustomType
public final class AwsIntegrationsAwsConnect {
    /**
    ...
    private AwsIntegrationsAwsConnect() {}
    /**
     * @return Specify each AWS region that includes the resources that you want to monitor.
     * 
     */
    ...
    public static Builder builder(AwsIntegrationsAwsConnect defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer metricsPollingInterval;
        public Builder() {}
        public Builder(AwsIntegrationsAwsConnect defaults) {
