...
@CustomType
public final class AzureIntegrationsContainers {
    /**
    ...
    private AzureIntegrationsContainers() {}
    /**
     * @return The data polling interval in seconds
     * 
     */
    ...
    public static Builder builder(AzureIntegrationsContainers defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> resourceGroups;
        public Builder() {}
        public Builder(AzureIntegrationsContainers defaults) {
        ...
        public AzureIntegrationsContainers build() {
            final var _resultValue = new AzureIntegrationsContainers();
