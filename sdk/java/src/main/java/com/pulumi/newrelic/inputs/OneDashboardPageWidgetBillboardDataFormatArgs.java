...
public final class OneDashboardPageWidgetBillboardDataFormatArgs extends com.pulumi.resources.ResourceArgs {

    public static final OneDashboardPageWidgetBillboardDataFormatArgs Empty = new OneDashboardPageWidgetBillboardDataFormatArgs();
    ...
    private OneDashboardPageWidgetBillboardDataFormatArgs() {}

    private OneDashboardPageWidgetBillboardDataFormatArgs(OneDashboardPageWidgetBillboardDataFormatArgs $) {
        this.format = $.format;
        this.name = $.name;
    ...
    public static Builder builder(OneDashboardPageWidgetBillboardDataFormatArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new OneDashboardPageWidgetBillboardDataFormatArgs();
        }

        public Builder(OneDashboardPageWidgetBillboardDataFormatArgs defaults) {
            $ = new OneDashboardPageWidgetBillboardDataFormatArgs(Objects.requireNonNull(defaults));
        }
        ...
        public OneDashboardPageWidgetBillboardDataFormatArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("OneDashboardPageWidgetBillboardDataFormatArgs", "name");
            }
            if ($.type == null) {
                throw new MissingRequiredPropertyException("OneDashboardPageWidgetBillboardDataFormatArgs", "type");
            }
            return $;
        }
    }
