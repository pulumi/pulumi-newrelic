...
import com.pulumi.newrelic.outputs.OneDashboardPageWidgetLogTableNullValueSeriesOverride;
...
@CustomType
public final class OneDashboardPageWidgetLogTableNullValue {
    /**
     ...
     * 
     */
    private @Nullable List<OneDashboardPageWidgetLogTableNullValueSeriesOverride> seriesOverrides;

    private OneDashboardPageWidgetLogTableNullValue() {}
    /**
     * @return Choose an option in displaying null values. Accepted values are `default`, `remove`, `preserve`, or `zero`.
     * 
     */
     ...
     * 
     */
    public List<OneDashboardPageWidgetLogTableNullValueSeriesOverride> seriesOverrides() {
    ...
    public static Builder builder(OneDashboardPageWidgetLogTableNullValue defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<OneDashboardPageWidgetLogTableNullValueSeriesOverride> seriesOverrides;
        public Builder() {}
        public Builder(OneDashboardPageWidgetLogTableNullValue defaults) {
        ...
        public Builder seriesOverrides(OneDashboardPageWidgetLogTableNullValueSeriesOverride... seriesOverrides) {
            return seriesOverrides(List.of(seriesOverrides));
        }
        public OneDashboardPageWidgetLogTableNullValue build() {
            final var _resultValue = new OneDashboardPageWidgetLogTableNullValue();
