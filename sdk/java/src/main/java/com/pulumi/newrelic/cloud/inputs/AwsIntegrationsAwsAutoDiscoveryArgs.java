...
public final class AwsIntegrationsAwsAutoDiscoveryArgs extends com.pulumi.resources.ResourceArgs {

    public static final AwsIntegrationsAwsAutoDiscoveryArgs Empty = new AwsIntegrationsAwsAutoDiscoveryArgs();
    ...
    private AwsIntegrationsAwsAutoDiscoveryArgs() {}

    private AwsIntegrationsAwsAutoDiscoveryArgs(AwsIntegrationsAwsAutoDiscoveryArgs $) {
    ...
    public static Builder builder(AwsIntegrationsAwsAutoDiscoveryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AwsIntegrationsAwsAutoDiscoveryArgs();
        }

        public Builder(AwsIntegrationsAwsAutoDiscoveryArgs defaults) {
            $ = new AwsIntegrationsAwsAutoDiscoveryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AwsIntegrationsAwsAutoDiscoveryArgs build() {
            return $;
        }
    }
