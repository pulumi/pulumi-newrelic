...
public final class AwsIntegrationsAwsFsxArgs extends com.pulumi.resources.ResourceArgs {

    public static final AwsIntegrationsAwsFsxArgs Empty = new AwsIntegrationsAwsFsxArgs();
    ...
    private AwsIntegrationsAwsFsxArgs() {}

    private AwsIntegrationsAwsFsxArgs(AwsIntegrationsAwsFsxArgs $) {
    ...
    public static Builder builder(AwsIntegrationsAwsFsxArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AwsIntegrationsAwsFsxArgs();
        }

        public Builder(AwsIntegrationsAwsFsxArgs defaults) {
            $ = new AwsIntegrationsAwsFsxArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AwsIntegrationsAwsFsxArgs build() {
            return $;
        }
    }
