...
public final class AzureIntegrationsCosmosDbArgs extends com.pulumi.resources.ResourceArgs {

    public static final AzureIntegrationsCosmosDbArgs Empty = new AzureIntegrationsCosmosDbArgs();
    ...
    private AzureIntegrationsCosmosDbArgs() {}

    private AzureIntegrationsCosmosDbArgs(AzureIntegrationsCosmosDbArgs $) {
    ...
    public static Builder builder(AzureIntegrationsCosmosDbArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AzureIntegrationsCosmosDbArgs();
        }

        public Builder(AzureIntegrationsCosmosDbArgs defaults) {
            $ = new AzureIntegrationsCosmosDbArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AzureIntegrationsCosmosDbArgs build() {
            return $;
        }
    }
