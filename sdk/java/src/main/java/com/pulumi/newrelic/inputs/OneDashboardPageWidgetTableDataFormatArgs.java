...
public final class OneDashboardPageWidgetTableDataFormatArgs extends com.pulumi.resources.ResourceArgs {

    public static final OneDashboardPageWidgetTableDataFormatArgs Empty = new OneDashboardPageWidgetTableDataFormatArgs();
    ...
    private OneDashboardPageWidgetTableDataFormatArgs() {}

    private OneDashboardPageWidgetTableDataFormatArgs(OneDashboardPageWidgetTableDataFormatArgs $) {
        this.format = $.format;
        this.name = $.name;
    ...
    public static Builder builder(OneDashboardPageWidgetTableDataFormatArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new OneDashboardPageWidgetTableDataFormatArgs();
        }

        public Builder(OneDashboardPageWidgetTableDataFormatArgs defaults) {
            $ = new OneDashboardPageWidgetTableDataFormatArgs(Objects.requireNonNull(defaults));
        }
        ...
        public OneDashboardPageWidgetTableDataFormatArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("OneDashboardPageWidgetTableDataFormatArgs", "name");
            }
            if ($.type == null) {
                throw new MissingRequiredPropertyException("OneDashboardPageWidgetTableDataFormatArgs", "type");
            }
            return $;
        }
    }
