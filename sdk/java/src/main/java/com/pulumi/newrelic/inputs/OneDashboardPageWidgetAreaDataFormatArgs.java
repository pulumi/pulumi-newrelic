...
public final class OneDashboardPageWidgetAreaDataFormatArgs extends com.pulumi.resources.ResourceArgs {

    public static final OneDashboardPageWidgetAreaDataFormatArgs Empty = new OneDashboardPageWidgetAreaDataFormatArgs();
    ...
    private OneDashboardPageWidgetAreaDataFormatArgs() {}

    private OneDashboardPageWidgetAreaDataFormatArgs(OneDashboardPageWidgetAreaDataFormatArgs $) {
        this.format = $.format;
        this.name = $.name;
    ...
    public static Builder builder(OneDashboardPageWidgetAreaDataFormatArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new OneDashboardPageWidgetAreaDataFormatArgs();
        }

        public Builder(OneDashboardPageWidgetAreaDataFormatArgs defaults) {
            $ = new OneDashboardPageWidgetAreaDataFormatArgs(Objects.requireNonNull(defaults));
        }
        ...
        public OneDashboardPageWidgetAreaDataFormatArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("OneDashboardPageWidgetAreaDataFormatArgs", "name");
            }
            if ($.type == null) {
                throw new MissingRequiredPropertyException("OneDashboardPageWidgetAreaDataFormatArgs", "type");
            }
            return $;
        }
    }
