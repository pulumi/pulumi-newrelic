...
@CustomType
public final class AzureIntegrationsVirtualNetworks {
    /**
    ...
    private AzureIntegrationsVirtualNetworks() {}
    /**
     * @return The data polling interval in seconds
     * 
     */
    ...
    public static Builder builder(AzureIntegrationsVirtualNetworks defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> resourceGroups;
        public Builder() {}
        public Builder(AzureIntegrationsVirtualNetworks defaults) {
