...
@CustomType
public final class AwsIntegrationsAwsRoute53resolver {
    /**
    ...
    private AwsIntegrationsAwsRoute53resolver() {}
    /**
     * @return Specify each AWS region that includes the resources that you want to monitor.
     * &lt;/details&gt;
     * 
    ...
    public static Builder builder(AwsIntegrationsAwsRoute53resolver defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer metricsPollingInterval;
        public Builder() {}
        public Builder(AwsIntegrationsAwsRoute53resolver defaults) {
