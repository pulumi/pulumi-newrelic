...
public final class AzureIntegrationsAutoDiscoveryArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private AzureIntegrationsAutoDiscoveryArgs() {}

    private AzureIntegrationsAutoDiscoveryArgs(AzureIntegrationsAutoDiscoveryArgs $) {
    ...
    public static Builder builder(AzureIntegrationsAutoDiscoveryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AzureIntegrationsAutoDiscoveryArgs();
        }

        public Builder(AzureIntegrationsAutoDiscoveryArgs defaults) {
            $ = new AzureIntegrationsAutoDiscoveryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AzureIntegrationsAutoDiscoveryArgs build() {
            return $;
        }
    }
