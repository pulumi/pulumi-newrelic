...
@CustomType
public final class AzureIntegrationsVms {
    /**
    ...
    public static Builder builder(AzureIntegrationsVms defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> resourceGroups;
        public Builder() {}
        public Builder(AzureIntegrationsVms defaults) {
        ...
        public AzureIntegrationsVms build() {
            final var _resultValue = new AzureIntegrationsVms();
