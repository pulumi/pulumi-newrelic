...
@CustomType
public final class AzureIntegrationsFirewalls {
    /**
    ...
    private AzureIntegrationsFirewalls() {}
    /**
     * @return The data polling interval in seconds
     * 
     */
    ...
    public static Builder builder(AzureIntegrationsFirewalls defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> resourceGroups;
        public Builder() {}
        public Builder(AzureIntegrationsFirewalls defaults) {
        ...
        public AzureIntegrationsFirewalls build() {
            final var _resultValue = new AzureIntegrationsFirewalls();
