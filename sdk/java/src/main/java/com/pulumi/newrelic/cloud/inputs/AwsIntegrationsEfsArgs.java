...
public final class AwsIntegrationsEfsArgs extends com.pulumi.resources.ResourceArgs {

    public static final AwsIntegrationsEfsArgs Empty = new AwsIntegrationsEfsArgs();
    ...
    private AwsIntegrationsEfsArgs() {}

    private AwsIntegrationsEfsArgs(AwsIntegrationsEfsArgs $) {
    ...
    public static Builder builder(AwsIntegrationsEfsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AwsIntegrationsEfsArgs();
        }

        public Builder(AwsIntegrationsEfsArgs defaults) {
            $ = new AwsIntegrationsEfsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AwsIntegrationsEfsArgs build() {
            return $;
        }
    }
