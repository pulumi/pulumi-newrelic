...
@CustomType
public final class AwsIntegrationsAwsQldb {
    /**
    ...
    private AwsIntegrationsAwsQldb() {}
    /**
     * @return Specify each AWS region that includes the resources that you want to monitor.
     * &lt;/details&gt;
     * 
    ...
    public static Builder builder(AwsIntegrationsAwsQldb defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer metricsPollingInterval;
        public Builder() {}
        public Builder(AwsIntegrationsAwsQldb defaults) {
