...
public final class AwsIntegrationsSecurityHubArgs extends com.pulumi.resources.ResourceArgs {

    public static final AwsIntegrationsSecurityHubArgs Empty = new AwsIntegrationsSecurityHubArgs();
    ...
    private AwsIntegrationsSecurityHubArgs() {}

    private AwsIntegrationsSecurityHubArgs(AwsIntegrationsSecurityHubArgs $) {
    ...
    public static Builder builder(AwsIntegrationsSecurityHubArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AwsIntegrationsSecurityHubArgs();
        }

        public Builder(AwsIntegrationsSecurityHubArgs defaults) {
            $ = new AwsIntegrationsSecurityHubArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AwsIntegrationsSecurityHubArgs build() {
            return $;
        }
    }
