...
@CustomType
public final class OneDashboardPageWidgetMarkdownNullValueSeriesOverride {
    /**
    ...
    public static Builder builder(OneDashboardPageWidgetMarkdownNullValueSeriesOverride defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String seriesName;
        public Builder() {}
        public Builder(OneDashboardPageWidgetMarkdownNullValueSeriesOverride defaults) {
        ...
        public OneDashboardPageWidgetMarkdownNullValueSeriesOverride build() {
            final var _resultValue = new OneDashboardPageWidgetMarkdownNullValueSeriesOverride();
