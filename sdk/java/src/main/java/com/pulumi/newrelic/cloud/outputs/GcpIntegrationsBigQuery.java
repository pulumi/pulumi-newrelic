...
@CustomType
public final class GcpIntegrationsBigQuery {
    /**
    ...
    public static Builder builder(GcpIntegrationsBigQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer metricsPollingInterval;
        public Builder() {}
        public Builder(GcpIntegrationsBigQuery defaults) {
