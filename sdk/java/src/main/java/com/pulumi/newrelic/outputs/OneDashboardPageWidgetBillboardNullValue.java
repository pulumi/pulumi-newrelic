...
import com.pulumi.newrelic.outputs.OneDashboardPageWidgetBillboardNullValueSeriesOverride;
...
@CustomType
public final class OneDashboardPageWidgetBillboardNullValue {
    /**
     ...
     * 
     */
    private @Nullable List<OneDashboardPageWidgetBillboardNullValueSeriesOverride> seriesOverrides;

    private OneDashboardPageWidgetBillboardNullValue() {}
    /**
     * @return Choose an option in displaying null values. Accepted values are `default`, `remove`, `preserve`, or `zero`.
     * 
     */
     ...
     * 
     */
    public List<OneDashboardPageWidgetBillboardNullValueSeriesOverride> seriesOverrides() {
    ...
    public static Builder builder(OneDashboardPageWidgetBillboardNullValue defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<OneDashboardPageWidgetBillboardNullValueSeriesOverride> seriesOverrides;
        public Builder() {}
        public Builder(OneDashboardPageWidgetBillboardNullValue defaults) {
        ...
        @CustomType.Setter
        public Builder seriesOverrides(@Nullable List<OneDashboardPageWidgetBillboardNullValueSeriesOverride> seriesOverrides) {
            this.seriesOverrides = seriesOverrides;
            return this;
        }
        public Builder seriesOverrides(OneDashboardPageWidgetBillboardNullValueSeriesOverride... seriesOverrides) {
