...
public final class OneDashboardPageWidgetLineDataFormatArgs extends com.pulumi.resources.ResourceArgs {

    public static final OneDashboardPageWidgetLineDataFormatArgs Empty = new OneDashboardPageWidgetLineDataFormatArgs();
    ...
    private OneDashboardPageWidgetLineDataFormatArgs() {}

    private OneDashboardPageWidgetLineDataFormatArgs(OneDashboardPageWidgetLineDataFormatArgs $) {
        this.format = $.format;
        this.name = $.name;
    ...
    public static Builder builder(OneDashboardPageWidgetLineDataFormatArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new OneDashboardPageWidgetLineDataFormatArgs();
        }

        public Builder(OneDashboardPageWidgetLineDataFormatArgs defaults) {
            $ = new OneDashboardPageWidgetLineDataFormatArgs(Objects.requireNonNull(defaults));
        }
        ...
        public OneDashboardPageWidgetLineDataFormatArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("OneDashboardPageWidgetLineDataFormatArgs", "name");
            }
            if ($.type == null) {
                throw new MissingRequiredPropertyException("OneDashboardPageWidgetLineDataFormatArgs", "type");
            }
            return $;
        }
    }
