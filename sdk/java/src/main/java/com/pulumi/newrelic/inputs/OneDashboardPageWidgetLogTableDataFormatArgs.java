...
public final class OneDashboardPageWidgetLogTableDataFormatArgs extends com.pulumi.resources.ResourceArgs {

    public static final OneDashboardPageWidgetLogTableDataFormatArgs Empty = new OneDashboardPageWidgetLogTableDataFormatArgs();
    ...
    private OneDashboardPageWidgetLogTableDataFormatArgs() {}

    private OneDashboardPageWidgetLogTableDataFormatArgs(OneDashboardPageWidgetLogTableDataFormatArgs $) {
        this.format = $.format;
        this.name = $.name;
    ...
    public static Builder builder(OneDashboardPageWidgetLogTableDataFormatArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new OneDashboardPageWidgetLogTableDataFormatArgs();
        }

        public Builder(OneDashboardPageWidgetLogTableDataFormatArgs defaults) {
            $ = new OneDashboardPageWidgetLogTableDataFormatArgs(Objects.requireNonNull(defaults));
        }
        ...
        public OneDashboardPageWidgetLogTableDataFormatArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("OneDashboardPageWidgetLogTableDataFormatArgs", "name");
            }
            if ($.type == null) {
                throw new MissingRequiredPropertyException("OneDashboardPageWidgetLogTableDataFormatArgs", "type");
            }
            return $;
        }
    }
