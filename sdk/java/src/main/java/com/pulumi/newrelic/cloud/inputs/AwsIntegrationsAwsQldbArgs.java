...
public final class AwsIntegrationsAwsQldbArgs extends com.pulumi.resources.ResourceArgs {

    public static final AwsIntegrationsAwsQldbArgs Empty = new AwsIntegrationsAwsQldbArgs();
    ...
    private AwsIntegrationsAwsQldbArgs() {}

    private AwsIntegrationsAwsQldbArgs(AwsIntegrationsAwsQldbArgs $) {
    ...
    public static Builder builder(AwsIntegrationsAwsQldbArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AwsIntegrationsAwsQldbArgs();
        }

        public Builder(AwsIntegrationsAwsQldbArgs defaults) {
            $ = new AwsIntegrationsAwsQldbArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AwsIntegrationsAwsQldbArgs build() {
            return $;
        }
    }
