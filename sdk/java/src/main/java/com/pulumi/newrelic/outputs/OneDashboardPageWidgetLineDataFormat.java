...
@CustomType
public final class OneDashboardPageWidgetLineDataFormat {
    /**
    ...
    private OneDashboardPageWidgetLineDataFormat() {}
    /**
     * @return (Optional) This attribute is provided when the `name` is that of a column comprising date/time values and the `type` attribute is set to `custom` defining the specific date format to be applied to your data.
     * 
     */
    ...
    public static Builder builder(OneDashboardPageWidgetLineDataFormat defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(OneDashboardPageWidgetLineDataFormat defaults) {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("OneDashboardPageWidgetLineDataFormat", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("OneDashboardPageWidgetLineDataFormat", "type");
            }
            this.type = type;
            return this;
        }
        public OneDashboardPageWidgetLineDataFormat build() {
            final var _resultValue = new OneDashboardPageWidgetLineDataFormat();
