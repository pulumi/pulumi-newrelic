...
public final class AwsIntegrationsAwsWafv2Args extends com.pulumi.resources.ResourceArgs {

    public static final AwsIntegrationsAwsWafv2Args Empty = new AwsIntegrationsAwsWafv2Args();
    ...
    private AwsIntegrationsAwsWafv2Args() {}

    private AwsIntegrationsAwsWafv2Args(AwsIntegrationsAwsWafv2Args $) {
    ...
    public static Builder builder(AwsIntegrationsAwsWafv2Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AwsIntegrationsAwsWafv2Args();
        }

        public Builder(AwsIntegrationsAwsWafv2Args defaults) {
            $ = new AwsIntegrationsAwsWafv2Args(Objects.requireNonNull(defaults));
        }
        ...
        public AwsIntegrationsAwsWafv2Args build() {
            return $;
        }
    }
