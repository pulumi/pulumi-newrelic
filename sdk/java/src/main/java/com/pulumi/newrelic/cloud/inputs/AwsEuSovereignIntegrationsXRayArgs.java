...
public final class AwsEuSovereignIntegrationsXRayArgs extends com.pulumi.resources.ResourceArgs {

    public static final AwsEuSovereignIntegrationsXRayArgs Empty = new AwsEuSovereignIntegrationsXRayArgs();
    ...
    private AwsEuSovereignIntegrationsXRayArgs() {}

    private AwsEuSovereignIntegrationsXRayArgs(AwsEuSovereignIntegrationsXRayArgs $) {
    ...
    public static Builder builder(AwsEuSovereignIntegrationsXRayArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AwsEuSovereignIntegrationsXRayArgs();
        }

        public Builder(AwsEuSovereignIntegrationsXRayArgs defaults) {
            $ = new AwsEuSovereignIntegrationsXRayArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AwsEuSovereignIntegrationsXRayArgs build() {
            return $;
        }
    }
