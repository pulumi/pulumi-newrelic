...
public final class EntityTagsTag {
    ...
    public static Builder builder(EntityTagsTag defaults) {
    ...
    public static final class Builder {
        ...
        private List<String> values;
        public Builder() {}
        public Builder(EntityTagsTag defaults) {
        ...
        public Builder key(String key) {
            if (key == null) {
              throw new MissingRequiredPropertyException("EntityTagsTag", "key");
            }
            this.key = key;
            return this;
        }
        ...
        public Builder values(List<String> values) {
            if (values == null) {
              throw new MissingRequiredPropertyException("EntityTagsTag", "values");
            }
            this.values = values;
            return this;
        }
