...
public final class AzureIntegrationsPostgresqlFlexibleArgs extends com.pulumi.resources.ResourceArgs {

    public static final AzureIntegrationsPostgresqlFlexibleArgs Empty = new AzureIntegrationsPostgresqlFlexibleArgs();
    ...
    private AzureIntegrationsPostgresqlFlexibleArgs() {}

    private AzureIntegrationsPostgresqlFlexibleArgs(AzureIntegrationsPostgresqlFlexibleArgs $) {
    ...
    public static Builder builder(AzureIntegrationsPostgresqlFlexibleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AzureIntegrationsPostgresqlFlexibleArgs();
        }

        public Builder(AzureIntegrationsPostgresqlFlexibleArgs defaults) {
            $ = new AzureIntegrationsPostgresqlFlexibleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AzureIntegrationsPostgresqlFlexibleArgs build() {
            return $;
        }
    }
