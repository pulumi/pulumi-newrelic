...
@CustomType
public final class OneDashboardPageWidgetHistogramNullValueSeriesOverride {
    /**
    ...
    private OneDashboardPageWidgetHistogramNullValueSeriesOverride() {}
    /**
     * @return Choose an option in displaying null values. Accepted values are `default`, `remove`, `preserve`, or `zero`.
     * 
     */
    ...
    public static Builder builder(OneDashboardPageWidgetHistogramNullValueSeriesOverride defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String seriesName;
        public Builder() {}
        public Builder(OneDashboardPageWidgetHistogramNullValueSeriesOverride defaults) {
        ...
        public OneDashboardPageWidgetHistogramNullValueSeriesOverride build() {
            final var _resultValue = new OneDashboardPageWidgetHistogramNullValueSeriesOverride();
