...
@CustomType
public final class AwsIntegrationsLambda {
    /**
    ...
    public static Builder builder(AwsIntegrationsLambda defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String tagValue;
        public Builder() {}
        public Builder(AwsIntegrationsLambda defaults) {
        ...
        public AwsIntegrationsLambda build() {
            final var _resultValue = new AwsIntegrationsLambda();
