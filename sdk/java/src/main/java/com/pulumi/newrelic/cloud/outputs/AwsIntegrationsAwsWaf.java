...
@CustomType
public final class AwsIntegrationsAwsWaf {
    /**
    ...
    public static Builder builder(AwsIntegrationsAwsWaf defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer metricsPollingInterval;
        public Builder() {}
        public Builder(AwsIntegrationsAwsWaf defaults) {
        ...
        public AwsIntegrationsAwsWaf build() {
            final var _resultValue = new AwsIntegrationsAwsWaf();
