...
@CustomType
public final class OneDashboardPageWidgetBillboardNullValueSeriesOverride {
    /**
    ...
    public static Builder builder(OneDashboardPageWidgetBillboardNullValueSeriesOverride defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String seriesName;
        public Builder() {}
        public Builder(OneDashboardPageWidgetBillboardNullValueSeriesOverride defaults) {
        ...
        public OneDashboardPageWidgetBillboardNullValueSeriesOverride build() {
            final var _resultValue = new OneDashboardPageWidgetBillboardNullValueSeriesOverride();
