...
@CustomType
public final class GcpIntegrationsFireBaseStorage {
    /**
    ...
    private GcpIntegrationsFireBaseStorage() {}
    /**
     * @return The data polling interval in seconds.
     * 
     */
    ...
    public static Builder builder(GcpIntegrationsFireBaseStorage defaults) {
    ...
    public static final class Builder {
        private @Nullable Integer metricsPollingInterval;
        public Builder() {}
        public Builder(GcpIntegrationsFireBaseStorage defaults) {
