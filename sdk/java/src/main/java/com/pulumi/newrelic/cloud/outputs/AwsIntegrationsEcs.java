...
@CustomType
public final class AwsIntegrationsEcs {
    /**
    ...
    public static Builder builder(AwsIntegrationsEcs defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String tagValue;
        public Builder() {}
        public Builder(AwsIntegrationsEcs defaults) {
        ...
        public AwsIntegrationsEcs build() {
            final var _resultValue = new AwsIntegrationsEcs();
