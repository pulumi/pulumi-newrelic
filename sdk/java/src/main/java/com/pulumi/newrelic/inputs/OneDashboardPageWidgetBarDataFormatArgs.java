...
public final class OneDashboardPageWidgetBarDataFormatArgs extends com.pulumi.resources.ResourceArgs {

    public static final OneDashboardPageWidgetBarDataFormatArgs Empty = new OneDashboardPageWidgetBarDataFormatArgs();
    ...
    private OneDashboardPageWidgetBarDataFormatArgs() {}

    private OneDashboardPageWidgetBarDataFormatArgs(OneDashboardPageWidgetBarDataFormatArgs $) {
        this.format = $.format;
        this.name = $.name;
    ...
    public static Builder builder(OneDashboardPageWidgetBarDataFormatArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new OneDashboardPageWidgetBarDataFormatArgs();
        }

        public Builder(OneDashboardPageWidgetBarDataFormatArgs defaults) {
            $ = new OneDashboardPageWidgetBarDataFormatArgs(Objects.requireNonNull(defaults));
        }
        ...
        public OneDashboardPageWidgetBarDataFormatArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("OneDashboardPageWidgetBarDataFormatArgs", "name");
            }
            if ($.type == null) {
                throw new MissingRequiredPropertyException("OneDashboardPageWidgetBarDataFormatArgs", "type");
            }
            return $;
        }
    }
