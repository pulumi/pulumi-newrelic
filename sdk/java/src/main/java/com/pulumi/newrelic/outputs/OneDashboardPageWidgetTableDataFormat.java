...
@CustomType
public final class OneDashboardPageWidgetTableDataFormat {
    /**
    ...
    private OneDashboardPageWidgetTableDataFormat() {}
    /**
     * @return (Optional) This attribute is provided when the `name` is that of a column comprising date/time values and the `type` attribute is set to `custom` defining the specific date format to be applied to your data.
     * 
     */
    ...
    public static Builder builder(OneDashboardPageWidgetTableDataFormat defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(OneDashboardPageWidgetTableDataFormat defaults) {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("OneDashboardPageWidgetTableDataFormat", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("OneDashboardPageWidgetTableDataFormat", "type");
            }
            this.type = type;
            return this;
        }
        public OneDashboardPageWidgetTableDataFormat build() {
            final var _resultValue = new OneDashboardPageWidgetTableDataFormat();
