...
@CustomType
public final class AwsIntegrationsAwsAthena {
    /**
    ...
    public static Builder builder(AwsIntegrationsAwsAthena defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer metricsPollingInterval;
        public Builder() {}
        public Builder(AwsIntegrationsAwsAthena defaults) {
        ...
        public AwsIntegrationsAwsAthena build() {
            final var _resultValue = new AwsIntegrationsAwsAthena();
