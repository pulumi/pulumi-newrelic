...
@CustomType
public final class OneDashboardPageWidgetPyNullValueSeriesOverride {
    /**
    ...
    private OneDashboardPageWidgetPyNullValueSeriesOverride() {}
    /**
     * @return Choose an option in displaying null values. Accepted values are `default`, `remove`, `preserve`, or `zero`.
     * 
     */
    ...
    public static Builder builder(OneDashboardPageWidgetPyNullValueSeriesOverride defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String seriesName;
        public Builder() {}
        public Builder(OneDashboardPageWidgetPyNullValueSeriesOverride defaults) {
