...
import com.pulumi.newrelic.inputs.OneDashboardPageWidgetHeatmapChartStylesArgs;
...
public final class OneDashboardPageWidgetHeatmapArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<OneDashboardPageWidgetHeatmapChartStylesArgs> chartStyles;
     ...
     * 
     */
    public Optional<Output<OneDashboardPageWidgetHeatmapChartStylesArgs>> chartStyles() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder chartStyles(@Nullable Output<OneDashboardPageWidgetHeatmapChartStylesArgs> chartStyles) {
         ...
         * 
         */
        public Builder chartStyles(OneDashboardPageWidgetHeatmapChartStylesArgs chartStyles) {
