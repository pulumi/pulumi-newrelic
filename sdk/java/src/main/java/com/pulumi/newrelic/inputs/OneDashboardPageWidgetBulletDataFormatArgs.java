...
public final class OneDashboardPageWidgetBulletDataFormatArgs extends com.pulumi.resources.ResourceArgs {

    public static final OneDashboardPageWidgetBulletDataFormatArgs Empty = new OneDashboardPageWidgetBulletDataFormatArgs();
    ...
    private OneDashboardPageWidgetBulletDataFormatArgs() {}

    private OneDashboardPageWidgetBulletDataFormatArgs(OneDashboardPageWidgetBulletDataFormatArgs $) {
        this.format = $.format;
        this.name = $.name;
    ...
    public static Builder builder(OneDashboardPageWidgetBulletDataFormatArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new OneDashboardPageWidgetBulletDataFormatArgs();
        }

        public Builder(OneDashboardPageWidgetBulletDataFormatArgs defaults) {
            $ = new OneDashboardPageWidgetBulletDataFormatArgs(Objects.requireNonNull(defaults));
        }
        ...
        public OneDashboardPageWidgetBulletDataFormatArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("OneDashboardPageWidgetBulletDataFormatArgs", "name");
            }
            if ($.type == null) {
                throw new MissingRequiredPropertyException("OneDashboardPageWidgetBulletDataFormatArgs", "type");
            }
            return $;
        }
    }
