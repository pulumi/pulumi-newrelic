...
namespace Pulumi.NewRelic.Synthetics
{
    ...
    /// ```
    /// </summary>
    [NewRelicResourceType("newrelic:synthetics/monitorDowntime:MonitorDowntime")]
    public partial class MonitorDowntime : global::Pulumi.CustomResource
    {
        ...
        public MonitorDowntime(string name, MonitorDowntimeArgs args, CustomResourceOptions? options = null)
            : base("newrelic:synthetics/monitorDowntime:MonitorDowntime", name, args ?? new MonitorDowntimeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MonitorDowntime(string name, Input<string> id, MonitorDowntimeState? state = null, CustomResourceOptions? options = null)
            : base("newrelic:synthetics/monitorDowntime:MonitorDowntime", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "newrelic:index/monitorDowntime:MonitorDowntime" },
                },
            };
