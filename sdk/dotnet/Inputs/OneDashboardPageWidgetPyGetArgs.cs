...
namespace Pulumi.NewRelic.Inputs
{
    ...
    public sealed class OneDashboardPageWidgetPyGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("chartStyles")]
        public Input<Inputs.OneDashboardPageWidgetPyChartStylesGetArgs>? ChartStyles { get; set; }

        [Input("colors")]
        private InputList<Inputs.OneDashboardPageWidgetPyColorGetArgs>? _colors;

        /// <summary>
        /// (Optional) A nested block that describes colors of your charts per series. See Nested Colors blocks below for details.
        /// </summary>
        public InputList<Inputs.OneDashboardPageWidgetPyColorGetArgs> Colors
        {
            get => _colors ?? (_colors = new InputList<Inputs.OneDashboardPageWidgetPyColorGetArgs>());
            set => _colors = value;
        }
        ...
        [Input("dataFormats")]
        private InputList<Inputs.OneDashboardPageWidgetPyDataFormatGetArgs>? _dataFormats;

        /// <summary>
        /// (Optional) A nested block that describes data format. See Nested DataFormat blocks below for details.
        /// </summary>
        public InputList<Inputs.OneDashboardPageWidgetPyDataFormatGetArgs> DataFormats
        {
            get => _dataFormats ?? (_dataFormats = new InputList<Inputs.OneDashboardPageWidgetPyDataFormatGetArgs>());
        ...
        public Input<Inputs.OneDashboardPageWidgetPyInitialSortingGetArgs>? InitialSorting { get; set; }
        ...
        {
            get => _nrqlQueries ?? (_nrqlQueries = new InputList<Inputs.OneDashboardPageWidgetPyNrqlQueryGetArgs>());
            set => _nrqlQueries = value;
        }

        [Input("nullValues")]
        private InputList<Inputs.OneDashboardPageWidgetPyNullValueGetArgs>? _nullValues;

        /// <summary>
        /// (Optional) A nested block that describes a Null Values. See Nested Null Values blocks below for details.
        /// </summary>
        public InputList<Inputs.OneDashboardPageWidgetPyNullValueGetArgs> NullValues
        {
            get => _nullValues ?? (_nullValues = new InputList<Inputs.OneDashboardPageWidgetPyNullValueGetArgs>());
        ...
        [Input("units")]
        private InputList<Inputs.OneDashboardPageWidgetPyUnitGetArgs>? _units;

        /// <summary>
        /// (Optional) A nested block that describes units on your Y axis. See Nested Units blocks below for details.
        /// </summary>
        public InputList<Inputs.OneDashboardPageWidgetPyUnitGetArgs> Units
        {
            get => _units ?? (_units = new InputList<Inputs.OneDashboardPageWidgetPyUnitGetArgs>());
            set => _units = value;
        }
        ...
        public OneDashboardPageWidgetPyGetArgs()
        {
        }
        public static new OneDashboardPageWidgetPyGetArgs Empty => new OneDashboardPageWidgetPyGetArgs();
    }
}
