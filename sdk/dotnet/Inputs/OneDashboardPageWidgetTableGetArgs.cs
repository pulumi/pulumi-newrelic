...
namespace Pulumi.NewRelic.Inputs
{
    ...
    public sealed class OneDashboardPageWidgetTableGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("chartStyles")]
        public Input<Inputs.OneDashboardPageWidgetTableChartStylesGetArgs>? ChartStyles { get; set; }

        [Input("colors")]
        private InputList<Inputs.OneDashboardPageWidgetTableColorGetArgs>? _colors;

        /// <summary>
        /// (Optional) A nested block that describes colors of your charts per series. See Nested Colors blocks below for details.
        /// </summary>
        public InputList<Inputs.OneDashboardPageWidgetTableColorGetArgs> Colors
        {
            get => _colors ?? (_colors = new InputList<Inputs.OneDashboardPageWidgetTableColorGetArgs>());
            set => _colors = value;
        }
        ...
        [Input("dataFormats")]
        private InputList<Inputs.OneDashboardPageWidgetTableDataFormatGetArgs>? _dataFormats;

        /// <summary>
        /// (Optional) A nested block that describes data format. See Nested DataFormat blocks below for details.
        /// </summary>
        public InputList<Inputs.OneDashboardPageWidgetTableDataFormatGetArgs> DataFormats
        {
            get => _dataFormats ?? (_dataFormats = new InputList<Inputs.OneDashboardPageWidgetTableDataFormatGetArgs>());
        ...
        public Input<Inputs.OneDashboardPageWidgetTableInitialSortingGetArgs>? InitialSorting { get; set; }
        ...
        private InputList<Inputs.OneDashboardPageWidgetTableNrqlQueryGetArgs>? _nrqlQueries;

        /// <summary>
        /// (Optional) Configuration for variables of type `Nrql`. See Nested nrql\_query blocks for Variables for details.
        /// </summary>
        public InputList<Inputs.OneDashboardPageWidgetTableNrqlQueryGetArgs> NrqlQueries
        {
            get => _nrqlQueries ?? (_nrqlQueries = new InputList<Inputs.OneDashboardPageWidgetTableNrqlQueryGetArgs>());
            set => _nrqlQueries = value;
        }

        [Input("nullValues")]
        private InputList<Inputs.OneDashboardPageWidgetTableNullValueGetArgs>? _nullValues;

        /// <summary>
        /// (Optional) A nested block that describes a Null Values. See Nested Null Values blocks below for details.
        /// </summary>
        public InputList<Inputs.OneDashboardPageWidgetTableNullValueGetArgs> NullValues
        {
            get => _nullValues ?? (_nullValues = new InputList<Inputs.OneDashboardPageWidgetTableNullValueGetArgs>());
        ...
        [Input("units")]
        private InputList<Inputs.OneDashboardPageWidgetTableUnitGetArgs>? _units;

        /// <summary>
        /// (Optional) A nested block that describes units on your Y axis. See Nested Units blocks below for details.
        /// </summary>
        public InputList<Inputs.OneDashboardPageWidgetTableUnitGetArgs> Units
        {
            get => _units ?? (_units = new InputList<Inputs.OneDashboardPageWidgetTableUnitGetArgs>());
            set => _units = value;
        }
        ...
        public OneDashboardPageWidgetTableGetArgs()
        {
        }
        public static new OneDashboardPageWidgetTableGetArgs Empty => new OneDashboardPageWidgetTableGetArgs();
    }
}
