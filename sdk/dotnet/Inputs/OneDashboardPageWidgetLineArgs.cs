...
namespace Pulumi.NewRelic.Inputs
{
    ...
    public sealed class OneDashboardPageWidgetLineArgs : Pulumi.ResourceArgs
    {
        ...
        private InputList<Inputs.OneDashboardPageWidgetLineQueryArgs>? _queries;

        /// <summary>
        /// (Required) A nested block that describes a NRQL Query. See Nested query blocks below for details.
        /// </summary>
        public InputList<Inputs.OneDashboardPageWidgetLineQueryArgs> Queries
        {
            get => _queries ?? (_queries = new InputList<Inputs.OneDashboardPageWidgetLineQueryArgs>());
            set => _queries = value;
        }
