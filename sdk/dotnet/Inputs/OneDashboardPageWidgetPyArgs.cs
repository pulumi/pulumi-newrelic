...
namespace Pulumi.NewRelic.Inputs
{
    ...
    public sealed class OneDashboardPageWidgetPyArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("chartStyles")]
        public Input<Inputs.OneDashboardPageWidgetPyChartStylesArgs>? ChartStyles { get; set; }

        [Input("colors")]
        private InputList<Inputs.OneDashboardPageWidgetPyColorArgs>? _colors;

        /// <summary>
        /// (Optional) A nested block that describes colors of your charts per series. See Nested Colors blocks below for details.
        /// </summary>
        public InputList<Inputs.OneDashboardPageWidgetPyColorArgs> Colors
        {
            get => _colors ?? (_colors = new InputList<Inputs.OneDashboardPageWidgetPyColorArgs>());
            set => _colors = value;
        }
        ...
        [Input("dataFormats")]
        private InputList<Inputs.OneDashboardPageWidgetPyDataFormatArgs>? _dataFormats;

        /// <summary>
        /// (Optional) A nested block that describes data format. See Nested DataFormat blocks below for details.
        /// </summary>
        public InputList<Inputs.OneDashboardPageWidgetPyDataFormatArgs> DataFormats
        {
            get => _dataFormats ?? (_dataFormats = new InputList<Inputs.OneDashboardPageWidgetPyDataFormatArgs>());
        ...
        public Input<Inputs.OneDashboardPageWidgetPyInitialSortingArgs>? InitialSorting { get; set; }
        ...
        private InputList<Inputs.OneDashboardPageWidgetPyNrqlQueryArgs>? _nrqlQueries;
        ...
        {
            get => _nrqlQueries ?? (_nrqlQueries = new InputList<Inputs.OneDashboardPageWidgetPyNrqlQueryArgs>());
            set => _nrqlQueries = value;
        }

        [Input("nullValues")]
        private InputList<Inputs.OneDashboardPageWidgetPyNullValueArgs>? _nullValues;

        /// <summary>
        /// (Optional) A nested block that describes a Null Values. See Nested Null Values blocks below for details.
        /// </summary>
        public InputList<Inputs.OneDashboardPageWidgetPyNullValueArgs> NullValues
        {
            get => _nullValues ?? (_nullValues = new InputList<Inputs.OneDashboardPageWidgetPyNullValueArgs>());
        ...
        [Input("units")]
        private InputList<Inputs.OneDashboardPageWidgetPyUnitArgs>? _units;

        /// <summary>
        /// (Optional) A nested block that describes units on your Y axis. See Nested Units blocks below for details.
        /// </summary>
        public InputList<Inputs.OneDashboardPageWidgetPyUnitArgs> Units
        {
            get => _units ?? (_units = new InputList<Inputs.OneDashboardPageWidgetPyUnitArgs>());
            set => _units = value;
        }
        ...
        public static new OneDashboardPageWidgetPyArgs Empty => new OneDashboardPageWidgetPyArgs();
    }
}
