...
namespace Pulumi.NewRelic.Inputs
{
    ...
    public sealed class OneDashboardPageWidgetStackedBarNullValueArgs : global::Pulumi.ResourceArgs
    {
        ...
        {
            get => _seriesOverrides ?? (_seriesOverrides = new InputList<Inputs.OneDashboardPageWidgetStackedBarNullValueSeriesOverrideArgs>());
            set => _seriesOverrides = value;
        }

        public OneDashboardPageWidgetStackedBarNullValueArgs()
        {
        }
        public static new OneDashboardPageWidgetStackedBarNullValueArgs Empty => new OneDashboardPageWidgetStackedBarNullValueArgs();
    }
}
