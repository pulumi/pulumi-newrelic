...
namespace Pulumi.NewRelic.Inputs
{
    ...
    public sealed class OneDashboardPageWidgetBillboardGetArgs : Pulumi.ResourceArgs
    {
        ...
        private InputList<Inputs.OneDashboardPageWidgetBillboardQueryGetArgs>? _queries;

        /// <summary>
        /// (Required) A nested block that describes a NRQL Query. See Nested query blocks below for details.
        /// </summary>
        public InputList<Inputs.OneDashboardPageWidgetBillboardQueryGetArgs> Queries
        {
            get => _queries ?? (_queries = new InputList<Inputs.OneDashboardPageWidgetBillboardQueryGetArgs>());
            set => _queries = value;
        }
