...
namespace Pulumi.NewRelic.Inputs
{
    ...
    public sealed class OneDashboardPageWidgetHeatmapArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("chartStyles")]
        public Input<Inputs.OneDashboardPageWidgetHeatmapChartStylesArgs>? ChartStyles { get; set; }
        ...
        [Input("dataFormats")]
        private InputList<Inputs.OneDashboardPageWidgetHeatmapDataFormatArgs>? _dataFormats;

        /// <summary>
        /// (Optional) A nested block that describes data format. See Nested DataFormat blocks below for details.
        /// </summary>
        public InputList<Inputs.OneDashboardPageWidgetHeatmapDataFormatArgs> DataFormats
        {
            get => _dataFormats ?? (_dataFormats = new InputList<Inputs.OneDashboardPageWidgetHeatmapDataFormatArgs>());
        ...
        public Input<Inputs.OneDashboardPageWidgetHeatmapInitialSortingArgs>? InitialSorting { get; set; }
