...
namespace Pulumi.NewRelic.Inputs
{
    ...
    public sealed class OneDashboardPageWidgetBarArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("chartStyles")]
        public Input<Inputs.OneDashboardPageWidgetBarChartStylesArgs>? ChartStyles { get; set; }
        ...
        [Input("dataFormats")]
        private InputList<Inputs.OneDashboardPageWidgetBarDataFormatArgs>? _dataFormats;

        /// <summary>
        /// (Optional) A nested block that describes data format. See Nested DataFormat blocks below for details.
        /// </summary>
        public InputList<Inputs.OneDashboardPageWidgetBarDataFormatArgs> DataFormats
        {
            get => _dataFormats ?? (_dataFormats = new InputList<Inputs.OneDashboardPageWidgetBarDataFormatArgs>());
        ...
        public Input<Inputs.OneDashboardPageWidgetBarInitialSortingArgs>? InitialSorting { get; set; }
