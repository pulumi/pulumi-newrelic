...
namespace Pulumi.NewRelic.Inputs
{
    ...
    public sealed class OneDashboardPageWidgetHeatmapColorArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        {
            get => _seriesOverrides ?? (_seriesOverrides = new InputList<Inputs.OneDashboardPageWidgetHeatmapColorSeriesOverrideArgs>());
            set => _seriesOverrides = value;
        }

        public OneDashboardPageWidgetHeatmapColorArgs()
        {
        }
        public static new OneDashboardPageWidgetHeatmapColorArgs Empty => new OneDashboardPageWidgetHeatmapColorArgs();
    }
}
