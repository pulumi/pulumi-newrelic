...
namespace Pulumi.NewRelic.Inputs
{
    ...
    public sealed class OneDashboardPageWidgetJsonGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("chartStyles")]
        public Input<Inputs.OneDashboardPageWidgetJsonChartStylesGetArgs>? ChartStyles { get; set; }
        ...
        [Input("dataFormats")]
        private InputList<Inputs.OneDashboardPageWidgetJsonDataFormatGetArgs>? _dataFormats;

        /// <summary>
        /// (Optional) A nested block that describes data format. See Nested DataFormat blocks below for details.
        /// </summary>
        public InputList<Inputs.OneDashboardPageWidgetJsonDataFormatGetArgs> DataFormats
        {
            get => _dataFormats ?? (_dataFormats = new InputList<Inputs.OneDashboardPageWidgetJsonDataFormatGetArgs>());
        ...
        public Input<Inputs.OneDashboardPageWidgetJsonInitialSortingGetArgs>? InitialSorting { get; set; }
