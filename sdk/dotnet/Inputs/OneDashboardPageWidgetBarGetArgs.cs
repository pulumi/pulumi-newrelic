...
namespace Pulumi.NewRelic.Inputs
{
    ...
    public sealed class OneDashboardPageWidgetBarGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("chartStyles")]
        public Input<Inputs.OneDashboardPageWidgetBarChartStylesGetArgs>? ChartStyles { get; set; }

        [Input("colors")]
        private InputList<Inputs.OneDashboardPageWidgetBarColorGetArgs>? _colors;

        /// <summary>
        /// (Optional) A nested block that describes colors of your charts per series. See Nested Colors blocks below for details.
        /// </summary>
        public InputList<Inputs.OneDashboardPageWidgetBarColorGetArgs> Colors
        {
            get => _colors ?? (_colors = new InputList<Inputs.OneDashboardPageWidgetBarColorGetArgs>());
            set => _colors = value;
        }
        ...
        [Input("dataFormats")]
        private InputList<Inputs.OneDashboardPageWidgetBarDataFormatGetArgs>? _dataFormats;

        /// <summary>
        /// (Optional) A nested block that describes data format. See Nested DataFormat blocks below for details.
        /// </summary>
        public InputList<Inputs.OneDashboardPageWidgetBarDataFormatGetArgs> DataFormats
        {
            get => _dataFormats ?? (_dataFormats = new InputList<Inputs.OneDashboardPageWidgetBarDataFormatGetArgs>());
        ...
        public Input<Inputs.OneDashboardPageWidgetBarInitialSortingGetArgs>? InitialSorting { get; set; }
        ...
        private InputList<Inputs.OneDashboardPageWidgetBarNrqlQueryGetArgs>? _nrqlQueries;

        /// <summary>
        /// (Optional) Configuration for variables of type `Nrql`. See Nested nrql\_query blocks for Variables for details.
        /// </summary>
        public InputList<Inputs.OneDashboardPageWidgetBarNrqlQueryGetArgs> NrqlQueries
        {
            get => _nrqlQueries ?? (_nrqlQueries = new InputList<Inputs.OneDashboardPageWidgetBarNrqlQueryGetArgs>());
            set => _nrqlQueries = value;
        }

        [Input("nullValues")]
        private InputList<Inputs.OneDashboardPageWidgetBarNullValueGetArgs>? _nullValues;

        /// <summary>
        /// (Optional) A nested block that describes a Null Values. See Nested Null Values blocks below for details.
        /// </summary>
        public InputList<Inputs.OneDashboardPageWidgetBarNullValueGetArgs> NullValues
        {
            get => _nullValues ?? (_nullValues = new InputList<Inputs.OneDashboardPageWidgetBarNullValueGetArgs>());
        ...
        [Input("units")]
        private InputList<Inputs.OneDashboardPageWidgetBarUnitGetArgs>? _units;

        /// <summary>
        /// (Optional) A nested block that describes units on your Y axis. See Nested Units blocks below for details.
        /// </summary>
        public InputList<Inputs.OneDashboardPageWidgetBarUnitGetArgs> Units
        {
            get => _units ?? (_units = new InputList<Inputs.OneDashboardPageWidgetBarUnitGetArgs>());
            set => _units = value;
        }
        ...
        public OneDashboardPageWidgetBarGetArgs()
        {
        }
        public static new OneDashboardPageWidgetBarGetArgs Empty => new OneDashboardPageWidgetBarGetArgs();
    }
}
