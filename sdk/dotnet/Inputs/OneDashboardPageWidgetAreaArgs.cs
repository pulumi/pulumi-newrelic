...
namespace Pulumi.NewRelic.Inputs
{
    ...
    public sealed class OneDashboardPageWidgetAreaArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("chartStyles")]
        public Input<Inputs.OneDashboardPageWidgetAreaChartStylesArgs>? ChartStyles { get; set; }

        [Input("colors")]
        private InputList<Inputs.OneDashboardPageWidgetAreaColorArgs>? _colors;

        /// <summary>
        /// (Optional) A nested block that describes colors of your charts per series. See Nested Colors blocks below for details.
        /// </summary>
        public InputList<Inputs.OneDashboardPageWidgetAreaColorArgs> Colors
        {
            get => _colors ?? (_colors = new InputList<Inputs.OneDashboardPageWidgetAreaColorArgs>());
            set => _colors = value;
        }
        ...
        [Input("dataFormats")]
        private InputList<Inputs.OneDashboardPageWidgetAreaDataFormatArgs>? _dataFormats;

        /// <summary>
        /// (Optional) A nested block that describes data format. See Nested DataFormat blocks below for details.
        /// </summary>
        public InputList<Inputs.OneDashboardPageWidgetAreaDataFormatArgs> DataFormats
        {
            get => _dataFormats ?? (_dataFormats = new InputList<Inputs.OneDashboardPageWidgetAreaDataFormatArgs>());
        ...
        public Input<Inputs.OneDashboardPageWidgetAreaInitialSortingArgs>? InitialSorting { get; set; }
        ...
        [Input("nullValues")]
        private InputList<Inputs.OneDashboardPageWidgetAreaNullValueArgs>? _nullValues;

        /// <summary>
        /// (Optional) A nested block that describes a Null Values. See Nested Null Values blocks below for details.
        /// </summary>
        public InputList<Inputs.OneDashboardPageWidgetAreaNullValueArgs> NullValues
        {
            get => _nullValues ?? (_nullValues = new InputList<Inputs.OneDashboardPageWidgetAreaNullValueArgs>());
        ...
        /// </summary>
        [Input("tooltip")]
        public Input<Inputs.OneDashboardPageWidgetAreaTooltipArgs>? Tooltip { get; set; }

        [Input("units")]
        private InputList<Inputs.OneDashboardPageWidgetAreaUnitArgs>? _units;

        /// <summary>
        /// (Optional) A nested block that describes units on your Y axis. See Nested Units blocks below for details.
        /// </summary>
        public InputList<Inputs.OneDashboardPageWidgetAreaUnitArgs> Units
        {
            get => _units ?? (_units = new InputList<Inputs.OneDashboardPageWidgetAreaUnitArgs>());
            set => _units = value;
        }
        ...
        public static new OneDashboardPageWidgetAreaArgs Empty => new OneDashboardPageWidgetAreaArgs();
    }
}
