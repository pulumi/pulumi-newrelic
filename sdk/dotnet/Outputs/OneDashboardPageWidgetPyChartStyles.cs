...
namespace Pulumi.NewRelic.Outputs
{
    ...
    [OutputType]
    public sealed class OneDashboardPageWidgetPyChartStyles
    {
        /// <summary>
        /// (Optional) A nested block that enables gradient effects on charts. Contains a single required attribute:
        /// </summary>
        public readonly Outputs.OneDashboardPageWidgetPyChartStylesGradient? Gradient;
        /// <summary>
        ...
        private OneDashboardPageWidgetPyChartStyles(
            Outputs.OneDashboardPageWidgetPyChartStylesGradient? gradient,
