...
namespace Pulumi.NewRelic.Cloud.Inputs
{
    ...
    public sealed class AwsIntegrationsKinesisGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("awsRegions")]
        ...
        /// </summary>
        [Input("fetchShards")]
        public Input<bool>? FetchShards { get; set; }
        ...
        public AwsIntegrationsKinesisGetArgs()
        {
        }
        public static new AwsIntegrationsKinesisGetArgs Empty => new AwsIntegrationsKinesisGetArgs();
    }
}
