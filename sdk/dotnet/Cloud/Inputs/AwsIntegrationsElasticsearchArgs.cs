...
namespace Pulumi.NewRelic.Cloud.Inputs
{
    ...
    public sealed class AwsIntegrationsElasticsearchArgs : global::Pulumi.ResourceArgs
    {
        [Input("awsRegions")]
        ...
        public AwsIntegrationsElasticsearchArgs()
        {
        }
        public static new AwsIntegrationsElasticsearchArgs Empty => new AwsIntegrationsElasticsearchArgs();
    }
}
