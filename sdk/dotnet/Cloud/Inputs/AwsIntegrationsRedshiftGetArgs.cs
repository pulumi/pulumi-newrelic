...
namespace Pulumi.NewRelic.Cloud.Inputs
{
    ...
    public sealed class AwsIntegrationsRedshiftGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("awsRegions")]
        ...
        public AwsIntegrationsRedshiftGetArgs()
        {
        }
        public static new AwsIntegrationsRedshiftGetArgs Empty => new AwsIntegrationsRedshiftGetArgs();
    }
}
