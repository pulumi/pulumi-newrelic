...
//	func main() {
//		pulumi.Run(func(ctx *pulumi.Context) error {
//			_, err := synthetics.NewMonitorDowntime(ctx, "sampleOneTimeNewrelicMonitorDowntime", &synthetics.MonitorDowntimeArgs{
...
//	func main() {
//		pulumi.Run(func(ctx *pulumi.Context) error {
//			_, err := synthetics.NewMonitorDowntime(ctx, "sampleDailyNewrelicMonitorDowntime", &synthetics.MonitorDowntimeArgs{
//				EndRepeat: &synthetics.MonitorDowntimeEndRepeatArgs{
...
//	func main() {
//		pulumi.Run(func(ctx *pulumi.Context) error {
//			_, err := synthetics.NewMonitorDowntime(ctx, "sampleWeeklyNewrelicMonitorDowntime", &synthetics.MonitorDowntimeArgs{
...
//	func main() {
//		pulumi.Run(func(ctx *pulumi.Context) error {
//			_, err := synthetics.NewMonitorDowntime(ctx, "sampleMonthlyNewrelicMonitorDowntime", &synthetics.MonitorDowntimeArgs{
//				EndRepeat: &synthetics.MonitorDowntimeEndRepeatArgs{
...
func NewMonitorDowntime(ctx *pulumi.Context,
	...
	aliases := pulumi.Aliases([]pulumi.Alias{
		{
			Type: pulumi.String("newrelic:index/monitorDowntime:MonitorDowntime"),
		},
	})
	opts = append(opts, aliases)
	opts = internal.PkgResourceDefaultOpts(opts)
	var resource MonitorDowntime
	err := ctx.RegisterResource("newrelic:synthetics/monitorDowntime:MonitorDowntime", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMonitorDowntime(ctx *pulumi.Context,
	...
	var resource MonitorDowntime
	err := ctx.ReadResource("newrelic:synthetics/monitorDowntime:MonitorDowntime", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
