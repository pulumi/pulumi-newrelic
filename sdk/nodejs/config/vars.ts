...
export let insightsAccountId: string | undefined = __config.get("insightsAccountId");
...
export let insightsQueryKey: string | undefined = __config.get("insightsQueryKey");
