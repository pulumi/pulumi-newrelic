...
# Use gotestsum in CI for better test output formatting
ifdef CI
...
LDFLAGS_EXTRAS= -X github.com/newrelic/terraform-provider-newrelic/v2/main.UserAgentServiceName=pulumi
...
# `cmd/pulumi-resource-newrelic/schema.json` is valid and up to date.
